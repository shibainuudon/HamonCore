/**
 *	@file	unit_test_expected_op_assign_copy.cpp
 *
 *	@brief	コピー代入演算子のテスト
 *
...
// Test constraints
static_assert(hamon::is_copy_assignable<hamon::expected<int, int>>::value, "");

// !is_copy_assignable_v<T>
static_assert(!hamon::is_copy_assignable<hamon::expected<NotCopyAssignable, int>>::value, "");

// !is_copy_constructible_v<T>
static_assert(!hamon::is_copy_assignable<hamon::expected<NotCopyConstructible, int>>::value, "");

// !is_copy_assignable_v<E>
static_assert(!hamon::is_copy_assignable<hamon::expected<int, NotCopyAssignable>>::value, "");

// !is_copy_constructible_v<E>
static_assert(!hamon::is_copy_assignable<hamon::expected<int, NotCopyConstructible>>::value, "");

// !is_nothrow_move_constructible_v<T> && is_nothrow_move_constructible_v<E>
static_assert(hamon::is_copy_assignable<hamon::expected<MoveMayThrow, int>>::value, "");

// is_nothrow_move_constructible_v<T> && !is_nothrow_move_constructible_v<E>
static_assert(hamon::is_copy_assignable<hamon::expected<int, MoveMayThrow>>::value, "");

// !is_nothrow_move_constructible_v<T> && !is_nothrow_move_constructible_v<E>
static_assert(!hamon::is_copy_assignable<hamon::expected<MoveMayThrow, MoveMayThrow>>::value, "");
...
{
	{
		hamon::expected<T, E> const src{hamon::in_place, T{3}};
	...
	{
		hamon::expected<T, E> const src{hamon::unexpect, E{5}};
	...
	{
		hamon::expected<T, E> const src{hamon::in_place, T{7}};
	...
	{
		hamon::expected<T, E> const src{hamon::unexpect, E{9}};
...
void trase_test_1()
{
	S3::reset();
	{
		hamon::expected<S3, int> const src{hamon::in_place};
	...
	S3::reset();
	{
		hamon::expected<S3, int> const src{hamon::unexpect};
		hamon::expected<S3, int> dst{hamon::in_place};
		dst = src;
	...
	S3::reset();
	{
		hamon::expected<int, S3> const src{hamon::in_place};
	...
	S3::reset();
	{
		hamon::expected<int, S3> const src{hamon::unexpect};
		hamon::expected<int, S3> dst{hamon::in_place};
		dst = src;
		EXPECT_EQ(1, S3::default_ctor_count);
		EXPECT_EQ(1, S3::copy_ctor_count);
...
void trase_test_2()
{
	S4::reset();
	{
		hamon::expected<S4, int> const src{hamon::in_place};
	...
	S4::reset();
	{
		hamon::expected<S4, int> const src{hamon::unexpect};
		hamon::expected<S4, int> dst{hamon::in_place};
		dst = src;
	...
	S4::reset();
	{
		hamon::expected<int, S4> const src{hamon::in_place};
	...
	S4::reset();
	{
		hamon::expected<int, S4> const src{hamon::unexpect};
		hamon::expected<int, S4> dst{hamon::in_place};
		dst = src;
		EXPECT_EQ(1, S4::default_ctor_count);
		EXPECT_EQ(1, S4::copy_ctor_count);
...
void exceptions_test()
{
	...
	{
		hamon::expected<ThrowOnCopyCtor, int> const src(hamon::in_place);
		hamon::expected<ThrowOnCopyCtor, int> dst(hamon::in_place);
		EXPECT_NO_THROW(dst = src);
		EXPECT_TRUE(dst.has_value());
	}
	{
		hamon::expected<ThrowOnCopyCtor, int> const src(hamon::in_place);
		hamon::expected<ThrowOnCopyCtor, int> dst(hamon::unexpect, 5);
		EXPECT_THROW(dst = src, ThrowOnCopyCtor::Exception);
		EXPECT_TRUE(!dst.has_value());
		EXPECT_TRUE(dst.error() == 5);
	}
	{
		hamon::expected<ThrowOnCopyCtor, int> const src(hamon::unexpect, 6);
		hamon::expected<ThrowOnCopyCtor, int> dst(hamon::in_place);
		EXPECT_NO_THROW(dst = src);
		EXPECT_TRUE(!dst.has_value());
	...
	{
		hamon::expected<ThrowOnCopyCtor, int> const src(hamon::unexpect, 7);
		hamon::expected<ThrowOnCopyCtor, int> dst(hamon::unexpect, 8);
		EXPECT_NO_THROW(dst = src);
		EXPECT_TRUE(!dst.has_value());
		EXPECT_TRUE(dst.error() == 7);
	}
	{
		hamon::expected<int, ThrowOnCopyCtor> const src(hamon::in_place, 10);
		hamon::expected<int, ThrowOnCopyCtor> dst(hamon::in_place, 11);
		EXPECT_NO_THROW(dst = src);
		EXPECT_TRUE(dst.has_value());
		EXPECT_TRUE(dst.value() == 10);
	}
	{
		hamon::expected<int, ThrowOnCopyCtor> const src(hamon::in_place, 12);
		hamon::expected<int, ThrowOnCopyCtor> dst(hamon::unexpect);
		EXPECT_NO_THROW(dst = src);
		EXPECT_TRUE(dst.has_value());
		EXPECT_TRUE(dst.value() == 12);
	}
	{
		hamon::expected<int, ThrowOnCopyCtor> const src(hamon::unexpect);
		hamon::expected<int, ThrowOnCopyCtor> dst(hamon::in_place, 13);
		EXPECT_THROW(dst = src, ThrowOnCopyCtor::Exception);
		EXPECT_TRUE(dst.has_value());
...
GTEST_TEST(ExpectedTest, OpAssignCopyTest)
{
