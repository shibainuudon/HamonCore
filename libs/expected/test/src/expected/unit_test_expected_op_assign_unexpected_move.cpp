/**
 *	@file	unit_test_expected_op_assign_unexpected_move.cpp
 *
...
static_assert( hamon::is_nothrow_assignable<hamon::expected<int, int>&, hamon::unexpected<int>&&>::value, "");
static_assert( hamon::is_nothrow_assignable<hamon::expected<MaybeNoexcept2<true, true>, int>&, hamon::unexpected<int>&&>::value, "");
static_assert( hamon::is_nothrow_assignable<hamon::expected<MaybeNoexcept2<true, false>, int>&, hamon::unexpected<int>&&>::value, "");
static_assert( hamon::is_nothrow_assignable<hamon::expected<MaybeNoexcept2<false, true>, int>&, hamon::unexpected<int>&&>::value, "");
static_assert( hamon::is_nothrow_assignable<hamon::expected<MaybeNoexcept2<false, false>, int>&, hamon::unexpected<int>&&>::value, "");
static_assert( hamon::is_nothrow_assignable<hamon::expected<int, MaybeNoexcept2<true, true>>&, hamon::unexpected<int>&&>::value, "");
static_assert(!hamon::is_nothrow_assignable<hamon::expected<int, MaybeNoexcept2<true, false>>&, hamon::unexpected<int>&&>::value, "");
static_assert(!hamon::is_nothrow_assignable<hamon::expected<int, MaybeNoexcept2<false, true>>&, hamon::unexpected<int>&&>::value, "");
static_assert(!hamon::is_nothrow_assignable<hamon::expected<int, MaybeNoexcept2<false, false>>&, hamon::unexpected<int>&&>::value, "");
#endif
...
GTEST_TEST(ExpectedTest, OpAssignUnexpectedMoveTest)
{
