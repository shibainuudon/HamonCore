/**
 *	@file	unit_test_expected_swap_free.cpp
 *
 *	@brief	swap のテスト
 *
...
static_assert(hamon::is_swappable<hamon::expected<int, int>>::value, "");

// !is_swappable_v<T>
static_assert(!hamon::is_swappable<hamon::expected<NotSwappable, int>>::value, "");

// !is_swappable_v<E>
static_assert(!hamon::is_swappable<hamon::expected<int, NotSwappable>>::value, "");
...
static_assert(!hamon::is_swappable<hamon::expected<NotMoveConstructible, int>>::value, "");

// !is_move_constructible_v<E>
static_assert(!hamon::is_swappable<hamon::expected<int, NotMoveConstructible>>::value, "");
...
static_assert(hamon::is_swappable<hamon::expected<MoveMayThrow, int>>::value, "");

// is_nothrow_move_constructible_v<T> && !is_nothrow_move_constructible_v<E>
static_assert(hamon::is_swappable<hamon::expected<int, MoveMayThrow>>::value, "");

// !is_nothrow_move_constructible_v<T> && !is_nothrow_move_constructible_v<E>
static_assert(!hamon::is_swappable<hamon::expected<MoveMayThrow, MoveMayThrow>>::value, "");

// Test noexcept
static_assert(hamon::is_nothrow_swappable<hamon::expected<int, int>>::value, "");

// !is_nothrow_move_constructible_v<T>
static_assert(!hamon::is_nothrow_swappable<hamon::expected<MoveMayThrow, int>>::value, "");

// !is_nothrow_move_constructible_v<E>
static_assert(!hamon::is_nothrow_swappable<hamon::expected<int, MoveMayThrow>>::value, "");
...
static_assert(!hamon::is_nothrow_swappable<hamon::expected<SwapMayThrow, int>>::value, "");

// !is_nothrow_swappable_v<E>
static_assert(!hamon::is_nothrow_swappable<hamon::expected<int, SwapMayThrow>>::value, "");
...
GTEST_TEST(ExpectedTest, SwapFreeTest)
{
