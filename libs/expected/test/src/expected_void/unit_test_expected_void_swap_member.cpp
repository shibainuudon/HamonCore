/**
 *	@file	unit_test_expected_void_swap_member.cpp
 *
 *	@brief	swap のテスト
 *
...
struct HasMemberSwap<E, hamon::void_t<decltype(
	hamon::declval<hamon::expected<void, E>&>().swap(hamon::declval<hamon::expected<void, E>&>()))>>
	: hamon::true_type{};

static_assert(HasMemberSwap<int>::value, "");

struct NotSwappable {};
void swap(NotSwappable&, NotSwappable&) = delete;

// !is_swappable_v<E>
static_assert(!HasMemberSwap<NotSwappable>::value, "");
...
static_assert(!HasMemberSwap<NotMoveConstructible>::value, "");
...
static_assert(MemberSwapNoexcept<int>::value, "");

// !is_nothrow_move_constructible_v<E>
static_assert(!MemberSwapNoexcept<MoveMayThrow>::value, "");
...
static_assert(!MemberSwapNoexcept<SwapMayThrow>::value, "");
...
GTEST_TEST(ExpectedVoidTest, SwapMemberTest)
{
