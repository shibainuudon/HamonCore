/**
 *	@file	unit_test_expected_void_ctor_unexpect_init_list.cpp
 *
...
HAMON_CXX14_CONSTEXPR bool test()
{
	...
	{
		hamon::expected<Void, S2> x{hamon::unexpect, {1,2,3}};
		VERIFY(!x.has_value());
	}
	{
		hamon::expected<Void, S3> x{hamon::unexpect, {1,2,3}, 5};
		VERIFY(!x.has_value());
	}
	return true;
}
...
{
	{
		hamon::expected<void, ComplexType> x {hamon::unexpect, {5, 6, 7, 8}, "Steps"};
		VERIFY(!x.has_value());
...
GTEST_TEST(ExpectedVoidTest, CtorUnexpectInitListTest)
{
