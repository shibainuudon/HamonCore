...
GTEST_TEST(FunctionalTest, InvokeTest)
{
	...
	}
	{
		...
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(0, hamon::invoke(function1));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(1, hamon::invoke(function2, 0.0f));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(2, hamon::invoke(function3, 0, 0.0f));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(3, hamon::invoke(f));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(4, hamon::invoke(&Foo::member_func, f));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(4, hamon::invoke(&Foo::member_func, &f));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(4, hamon::invoke(&Foo::member_func, hamon::ref(f)));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(4, hamon::invoke(&Foo::member_func, hamon::cref(f)));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, b, 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, &b, 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, hamon::ref(b), 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, hamon::cref(b), 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, d, 0));
		                      EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, &d, 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, hamon::ref(d), 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(5, hamon::invoke(&Base::nonvirtual_func, hamon::cref(d), 0));
		...
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(7, hamon::invoke(&Derived::nonvirtual_func, d, 0, 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(7, hamon::invoke(&Derived::nonvirtual_func, &d, 0, 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(7, hamon::invoke(&Derived::nonvirtual_func, hamon::ref(d), 0, 0));
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(7, hamon::invoke(&Derived::nonvirtual_func, hamon::cref(d), 0, 0));
