...
//	static_assert(hamon::detail::cpp17_swappable<hamon::hash<T>>, "");	// TODO
...
void float_test(void)
{
	...
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(T(+0.0)), h(T(+0.0)));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(T(+0.0)), h(T(-0.0)));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(T(-0.0)), h(T(+0.0)));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(T(-0.0)), h(T(-0.0)));

	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(T(-1)), h(T(-1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T(-1)), h(T( 0)));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T(-1)), h(T( 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T( 0)), h(T(-1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(T( 0)), h(T( 0)));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T( 0)), h(T( 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T( 1)), h(T(-1)));
	...
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T(0)), h(T(0) + eps));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T(0)), h(T(0) - eps));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T(1)), h(T(1) + eps));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(T(1)), h(T(1) - eps));

	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(eps), h(eps));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(max), h(max));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(min), h(min));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(low), h(low));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(inf), h( inf));
	HAMON_CXX11_CONSTEXPR_EXPECT_NE(h(inf), h(-inf));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(h(nan), h(nan));
