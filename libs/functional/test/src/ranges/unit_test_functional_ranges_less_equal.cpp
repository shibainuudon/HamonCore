/**
 *	@file	unit_test_functional_ranges_less_equal.cpp
 *
...
{
	using F = hamon::ranges::less_equal;
	...
	static_assert( hamon::ranges::less_equal{}(99, 99.0), "");
	static_assert(!hamon::ranges::less_equal{}(99.01, 99), "");
	static_assert( hamon::ranges::less_equal{}(99, 140L), "");
