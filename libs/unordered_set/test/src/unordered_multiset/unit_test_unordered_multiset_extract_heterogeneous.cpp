/**
 *	@file	unit_test_unordered_multiset_extract_heterogeneous.cpp
 *
 *	@brief	extract のテスト
 *
...
UNORDERED_MULTISET_TEST_CONSTEXPR bool test()
{
	...
	using Set2 = hamon::unordered_multiset<Key, TransparentHash>;
	using Set3 = hamon::unordered_multiset<Key, hamon::hash<Key>, hamon::equal_to<>>;
	using Set4 = hamon::unordered_multiset<Key, TransparentHash, hamon::equal_to<>>;
