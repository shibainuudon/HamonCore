/**
 *	@file	unit_test_unordered_multiset_pmr.cpp
 *
 *	@brief	pmr::unordered_multiset のテスト
 */
...
GTEST_TEST(UnorderedMultisetTest, PmrTest)
{
	hamon::pmr::monotonic_buffer_resource mr;
	hamon::pmr::unordered_multiset<hamon::string> ums ({"1st element", "2nd element", "3rd element", }, &mr);
