...
UNORDERED_MULTISET_TEST_CONSTEXPR bool test3()
{
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(2));
		VERIFY(r != v1.end());
		VERIFY(*r == 2);
	}
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(4));
		VERIFY(r == v1.end());
	}
...
UNORDERED_MULTISET_TEST_CONSTEXPR bool test4()
{
	...
	{
		auto r = v2.insert(v2.cbegin(), v1.extract(1));
		VERIFY(r == v2.end());
	}
	...
	{
		auto r = v2.insert(v2.cbegin(), v1.extract(2));
		VERIFY(r != v2.end());
		VERIFY(*r == 2);
	}
	...
	{
		auto r = v2.insert(v2.cbegin(), v1.extract(4));
		VERIFY(r != v2.end());
		VERIFY(*r == 4);
	}
