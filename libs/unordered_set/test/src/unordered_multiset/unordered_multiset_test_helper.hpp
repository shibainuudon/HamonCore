...
template <>
struct hamon::hash<hamon_unordered_multiset_test::NonCopyableMovable>
{
	HAMON_CXX11_CONSTEXPR
	hamon::size_t operator()(hamon_unordered_multiset_test::NonCopyableMovable const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_multiset_test::ThrowIfNegative>
{
	hamon::size_t operator()(hamon_unordered_multiset_test::ThrowIfNegative const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_multiset_test::ThrowOnCopy>
{
	hamon::size_t operator()(hamon_unordered_multiset_test::ThrowOnCopy const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_multiset_test::ThrowOnMove>
{
	hamon::size_t operator()(hamon_unordered_multiset_test::ThrowOnMove const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_multiset_test::ThrowOnCopyIfNegative>
{
	hamon::size_t operator()(hamon_unordered_multiset_test::ThrowOnCopyIfNegative const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
