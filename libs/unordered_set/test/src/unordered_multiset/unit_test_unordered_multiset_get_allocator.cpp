/**
 *	@file	unit_test_unordered_multiset_get_allocator.cpp
 *
...
{
	{
		...
		using Set = hamon::unordered_multiset<Key, hamon::hash<Key>, hamon::equal_to<Key>, Allocator>;
...
GTEST_TEST(UnorderedMultisetTest, GetAllocatorTest)
{
