/**
 *	@file	unit_test_unordered_multiset_iterator.cpp
 *
 *	@brief	iterator のテスト
 *
...
//	static_assert(!hamon::bidirectional_iterator_t<iterator>::value, "");
	...
	static_assert(hamon::is_same<value_type const&, hamon::iter_reference_t<iterator>>::value, "");
...
GTEST_TEST(UnorderedMultisetTest, IteratorTest)
{
