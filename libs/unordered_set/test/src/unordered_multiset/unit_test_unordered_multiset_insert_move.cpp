/**
 *	@file	unit_test_unordered_multiset_insert_move.cpp
 *
 *	@brief	insert のテスト
 *
...
UNORDERED_MULTISET_TEST_CONSTEXPR bool test1()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<Set&>().insert(hamon::declval<ValueType&&>())), Iterator>::value, "");
...
GTEST_TEST(UnorderedMultisetTest, InsertMoveTest)
{
