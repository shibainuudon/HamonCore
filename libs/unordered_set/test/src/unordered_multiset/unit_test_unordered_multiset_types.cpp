...
{
	UNORDERED_MULTISET_TEST_CONSTEXPR_EXPECT_TRUE((test<int, hamon::hash<int>, hamon::equal_to<int>, hamon::allocator<int>>()));
	UNORDERED_MULTISET_TEST_CONSTEXPR_EXPECT_TRUE((test<char, hamon::hash<char>, hamon::equal_to<>, hamon::allocator<char>>()));
	UNORDERED_MULTISET_TEST_CONSTEXPR_EXPECT_TRUE((test<float, decltype(hamon::ranges::hash), hamon::equal_to<>, hamon::allocator<float>>()));
}
