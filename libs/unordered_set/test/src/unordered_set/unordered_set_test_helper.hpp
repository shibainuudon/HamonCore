/**
 *	@file	unordered_set_test_helper.hpp
 *
 *	@brief
 */

#ifndef HAMON_UNORDERED_SET_TEST_HELPER_HPP
#define HAMON_UNORDERED_SET_TEST_HELPER_HPP
...
struct NonCopyableMovable
{
	...
	HAMON_CXX11_CONSTEXPR
	hamon::size_t hash() const
	{
		return hamon::hash<int>{}(value);
	}
};
...
struct ThrowIfNegative
{
	...
	friend bool operator==(int lhs, ThrowIfNegative const& rhs)
	{
		return lhs == rhs.value;
	}

	friend bool operator==(ThrowIfNegative const& lhs, int rhs)
	{
		return lhs.value == rhs;
	}

	bool operator==(ThrowIfNegative const& rhs) const
	{
		return value == rhs.value;
	}
...
struct ThrowOnCopy
{
	...
	bool operator==(ThrowOnCopy const& rhs) const
	{
		return value == rhs.value;
	}
...
struct ThrowOnMove
{
	...
	bool operator==(ThrowOnMove const& rhs) const
	{
		return value == rhs.value;
	}
...
struct ThrowOnCopyIfNegative
{
	...
	bool operator==(ThrowOnCopyIfNegative const& rhs) const
	{
		return value == rhs.value;
	}
...
template <>
struct hamon::hash<hamon_unordered_set_test::NonCopyableMovable>
{
	HAMON_CXX11_CONSTEXPR
	hamon::size_t operator()(hamon_unordered_set_test::NonCopyableMovable const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_set_test::ThrowIfNegative>
{
	hamon::size_t operator()(hamon_unordered_set_test::ThrowIfNegative const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_set_test::ThrowOnCopy>
{
	hamon::size_t operator()(hamon_unordered_set_test::ThrowOnCopy const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_set_test::ThrowOnMove>
{
	hamon::size_t operator()(hamon_unordered_set_test::ThrowOnMove const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
template <>
struct hamon::hash<hamon_unordered_set_test::ThrowOnCopyIfNegative>
{
	hamon::size_t operator()(hamon_unordered_set_test::ThrowOnCopyIfNegative const& v) const HAMON_NOEXCEPT
	{
		return v.hash();
	}
};
...
#endif // HAMON_UNORDERED_SET_TEST_HELPER_HPP
