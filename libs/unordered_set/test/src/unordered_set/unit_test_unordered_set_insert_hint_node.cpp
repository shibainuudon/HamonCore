...
UNORDERED_SET_TEST_CONSTEXPR bool test2()
{
	...
	{
		auto r = v1.insert(v1.begin(), v2.extract(Key{6}));
		VERIFY(r != v1.end());
		VERIFY(*r == Key{6});
	}
...
UNORDERED_SET_TEST_CONSTEXPR bool test3()
{
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(1));
		VERIFY(r != v1.end());
		VERIFY(*r == 1);
	}
	...
	{
		auto r = v2.insert(v2.cend(), v1.extract(4));
		VERIFY(r != v2.end());
		VERIFY(*r == 4);
	}
	...
	{
		auto r = v2.insert(v2.cend(), v1.extract(2));
		VERIFY(r != v2.end());
		VERIFY(*r == 2);
	}
...
UNORDERED_SET_TEST_CONSTEXPR bool test4()
{
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(1));
		VERIFY(r != v1.end());
		VERIFY(*r == 1);
	}
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(2));
		VERIFY(r != v1.end());
		VERIFY(*r == 2);
	}
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(4));
		VERIFY(r == v1.end());
	}
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(3));
		VERIFY(r != v1.end());
		VERIFY(*r == 3);
	}
