...
UNORDERED_SET_TEST_CONSTEXPR bool test1_impl()
{
	...
	// (f, l)
	{
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key>>::value, "");
	}
	// (f, l, n)
	{
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, 8);
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key>>::value, "");
	}
	// (f, l, n, hf)
	{
		using Hash = TransparentHash;
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, 8, Hash{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash>>::value, "");
	}
	// (f, l, n, hf, eql)
	{
		using Hash = TransparentHash;
		using Pred = hamon::equal_to<>;
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, 8, Hash{}, Pred{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, Pred>>::value, "");
	}
	// (f, l, n, hf, eql, a)
	{
		using Hash = TransparentHash;
		...
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, 8, Hash{}, Pred{}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, Pred, Allocator>>::value, "");
	}
	// (f, l, n, a)
	{
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, 8, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, typename Set::hasher, typename Set::key_equal, Allocator>>::value, "");
	}
	// (f, l, n, hf, a)
	{
		using Hash = TransparentHash;
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, 8, Hash{}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, typename Set::key_equal, Allocator>>::value, "");
	}
#if !defined(HAMON_USE_STD_UNORDERED_SET)	// TODO(LWG 2713)
	// (f, l, a)
	{
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(Iterator{a}, Iterator{a + 6}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, typename Set::hasher, typename Set::key_equal, Allocator>>::value, "");
	}
#endif
...
UNORDERED_SET_TEST_CONSTEXPR bool test2_impl()
{
	using Set = hamon::unordered_set<Key>;
	using ValueType = typename Set::value_type;
	...
	// (from_range, rg)
	{
		hamon::unordered_set v(hamon::from_range, r);
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key>>::value, "");
	}
	// (from_range, rg, n)
	{
		hamon::unordered_set v(hamon::from_range, r, 8);
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key>>::value, "");
	}
	// (from_range, rg, n, hf)
	{
		using Hash = TransparentHash;
		hamon::unordered_set v(hamon::from_range, r, 8, Hash{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash>>::value, "");
	}
	// (from_range, rg, n, hf, eql)
	{
		using Hash = TransparentHash;
		using Pred = hamon::equal_to<>;
		hamon::unordered_set v(hamon::from_range, r, 8, Hash{}, Pred{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, Pred>>::value, "");
	}
	// (from_range, rg, n, hf, eql, a)
	{
		...
		using Pred = hamon::equal_to<>;
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(hamon::from_range, r, 8, Hash{}, Pred{}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, Pred, Allocator>>::value, "");
	}
	// (from_range, rg, n, a)
	{
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(hamon::from_range, r, 8, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, typename Set::hasher, typename Set::key_equal, Allocator>>::value, "");
	}
	// (from_range, rg, n, hf, a)
	{
		using Hash = TransparentHash;
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(hamon::from_range, r, 8, Hash{}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, typename Set::key_equal, Allocator>>::value, "");
	}
#if !defined(HAMON_USE_STD_UNORDERED_SET)	// TODO(LWG 2713)
	// (from_range, rg, a)
	{
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v(hamon::from_range, r, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, typename Set::hasher, typename Set::key_equal, Allocator>>::value, "");
	}
#endif
...
UNORDERED_SET_TEST_CONSTEXPR bool test3()
{
	...
	// (il)
	{
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key>>::value, "");
	}
	// (il, n)
	{
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, 8);
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key>>::value, "");
	}
	// (il, n, hf)
	{
		using Hash = TransparentHash;
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, 8, Hash{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash>>::value, "");
	}
	// (il, n, hf, eql)
	{
		using Hash = TransparentHash;
		using Pred = hamon::equal_to<>;
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, 8, Hash{}, Pred{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, Pred>>::value, "");
	}
	// (il, n, hf, eql, a)
	{
		...
		using Pred = hamon::equal_to<>;
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, 8, Hash{}, Pred{}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, Pred, Allocator>>::value, "");
	}
	// (il, n, a)
	{
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, 8, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, typename Set::hasher, typename Set::key_equal, Allocator>>::value, "");
	}
	// (il, n, hf, a)
	{
		using Hash = TransparentHash;
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, 8, Hash{}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, Hash, typename Set::key_equal, Allocator>>::value, "");
	}
#if !defined(HAMON_USE_STD_UNORDERED_SET)	// TODO(LWG 2713)
	// (il, a)
	{
		using Allocator = hamon::allocator<ValueType>;
		hamon::unordered_set v({Key{1}, Key{2}, Key{3}}, Allocator{});
		static_assert(hamon::is_same<decltype(v), hamon::unordered_set<Key, typename Set::hasher, typename Set::key_equal, Allocator>>::value, "");
	}
#endif
