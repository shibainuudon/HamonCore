...
#if defined(HAMON_USE_STD_STACK) && (HAMON_CXX_STANDARD < 17)
	static_assert(hamon::is_same<decltype(hamon::declval<Stack&>().emplace()), void>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<Stack&>().emplace(hamon::declval<T>())), void>::value, "");
#else
