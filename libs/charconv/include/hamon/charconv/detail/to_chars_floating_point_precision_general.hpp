...
static constexpr uint32_t special_X_table_32[63] = { 0x38C73ABCu, 0x3A79096Bu, 0x3C1BA5E3u, 0x3DC28F5Cu, 0x3F733333u,
...
static constexpr uint32_t ordinary_X_table_32[44] = { 0x38D1B717u, 0x3A83126Eu, 0x3C23D70Au, 0x3DCCCCCCu, 0x3F7FFFFFu,
...
struct general_precision_tables<float>
{
	...
	static constexpr uint32_t const* special_X_table()
	{
		return special_X_table_32;
	}

	static constexpr int max_P() { return 39; }

	static constexpr uint32_t const* ordinary_X_table()
	{
		return ordinary_X_table_32;
	}
};

static constexpr uint64_t special_X_table_64[195] = { 0x3F18E757928E0C9Du, 0x3F4F212D77318FC5u, 0x3F8374BC6A7EF9DBu,
...
static constexpr uint64_t ordinary_X_table_64[314] = { 0x3F1A36E2EB1C432Cu, 0x3F50624DD2F1A9FBu, 0x3F847AE147AE147Au,
...
struct general_precision_tables<double>
{
	...
	static constexpr uint64_t const* special_X_table()
	{
		return special_X_table_64;
	}

	static constexpr int max_P() { return 309; }

	static constexpr uint64_t const* ordinary_X_table()
	{
		return ordinary_X_table_64;
	}
};
