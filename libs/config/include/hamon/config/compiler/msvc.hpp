...
// Visual Studio 2019 Version 16.11.(45-60)
...
// Visual Studio 2022 Preview Version 17.14.(6-8) Preview 1.0
...
// Visual Studio 2022 Preview Version 17.14.(11-12) Preview 1.0
#if (_MSC_FULL_VER >= 194435214)
#endif

// Visual Studio 2022 Preview Version 17.14.13 Preview 1.0
...
// Visual Studio 2022 Version 17.14.(11-12)
#if (_MSC_FULL_VER >= 194435214)
#endif
...
// Visual Studio 2022 Version 17.14.(15-17)
#if (_MSC_FULL_VER >= 194435217)
#endif

// Visual Studio 2022 Version 17.14.(18-19)
#if (_MSC_FULL_VER >= 194435219)
#endif

// Visual Studio 2022 Version 17.14.20
#if (_MSC_FULL_VER >= 194435220)
#endif

// Visual Studio 2022 Version 17.14.21
#if (_MSC_FULL_VER >= 194435221)
#endif

// Visual Studio 2022 Version 17.14.(22-26)
#if (_MSC_FULL_VER >= 194435222)
#endif

// Visual Studio 2022 Version 17.14.27
...
// Visual Studio 2022 Version 17.14.(29-30)
#if (_MSC_FULL_VER >= 194435225)
#endif

// Visual Studio 2022 Version 17.14.31
#if (_MSC_FULL_VER >= 194435226)
#endif

// Visual Studio 2022 Version 17.14.(32-33)
#if (_MSC_FULL_VER >= 194435227)
#endif

// Visual Studio 2022 Version 17.14.(34-40)
...
// Visual Studio 2026 Version: 18.0.0 Insiders [11104.47],[11109.219]
#if (_MSC_FULL_VER >= 195035615)
#endif

// Visual Studio 2026 Version: 18.0.0 Insiders [11111.16]
#if (_MSC_FULL_VER >= 195035702)
#endif

// Visual Studio 2026 Version: 18.0.0 Insiders [11116.177]
#if (_MSC_FULL_VER >= 195035710)
#endif

// Visual Studio 2026 Version: 18.0.0 Insiders [11121.172],[11123.170],[11201.2],[11206.111]
#if (_MSC_FULL_VER >= 195035717)
#endif

// Visual Studio 2026 Version: 18.0.0 Insiders [11218.70]
#if (_MSC_FULL_VER >= 195035718)
#endif
...
#if (_MSC_FULL_VER >= 195035719)
#endif

// Visual Studio 2026 Version: 18.1.0
#if (_MSC_FULL_VER >= 195035720)
#endif

// Visual Studio 2026 Version: 18.1.1
#if (_MSC_FULL_VER >= 195035721)
#endif

// Visual Studio 2026 Version: 18.2.0
#if (_MSC_FULL_VER >= 195035722)
#endif

// Visual Studio 2026 Version: 18.2.1
#if (_MSC_FULL_VER >= 195035723)
#endif

// Visual Studio 2026 Version: 18.3.(0-1)
...
// Visual Studio 2026 Version: 18.4.1
...
// Visual Studio 2026 Version: 18.5.(0-1)
#if (_MSC_FULL_VER >= 195035729)
#endif

// Visual Studio 2026 Version: 18.5.2
...
// Visual Studio 2026 Version: 18.6.2
...
// Visual Studio 2026 Version: 18.7.(1-3)
#if (_MSC_FULL_VER >= 195136248)
#endif

// Visual Studio 2026 Version: 18.8.0
#if (_MSC_FULL_VER >= 195136248)
#endif
...
// Visual Studio 2026 Version: 18.9.(0-2)
...
#define HAMON_HAS_CXX26_FOLD_EXPRESSIONS							// P2963R3	Ordering of constraints involving fold expressions						__cpp_fold_expressions >= 202406L
...
#define HAMON_HAS_CXX26_TEMPLATE_PARAMETERS							// P2841R7	Concept and variable-template template-parameters						__cpp_template_parameters >= 202502L
#define HAMON_HAS_CXX26_TRIVIAL_UNION								// P3074R7,P3726R2	trivial unions (was std::uninitialized<T>)						__cpp_trivial_union >= 202603L
...
#define HAMON_HAS_CXX26_ALLOW_PP_LINE_BEFORE_MODULE_DECLARATIONS	// P3868R1	DR20: Allow #line before module declarations
#define HAMON_HAS_CXX26_CTAD_FOR_TYPE_TEMPLATE_TEMPLATE_PARAMETERS	// P3865R3	DR17: Class template argument deduction (CTAD) for type template template parameters
#define HAMON_HAS_CXX26_CONST_IFICATION_OF_SPLICE_EXPRESSIONS		// P3598R0	const-ification of Splice Expressions
