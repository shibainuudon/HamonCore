/**
 *	@file	copy_symlink.hpp
 *
 *	@brief	copy_symlink の定義
 */

#ifndef HAMON_FILESYSTEM_COPY_SYMLINK_HPP
#define HAMON_FILESYSTEM_COPY_SYMLINK_HPP
...
void copy_symlink(path const& existing_symlink, path const& new_symlink, hamon::error_code& ec) noexcept;
...
#endif // HAMON_FILESYSTEM_COPY_SYMLINK_HPP
