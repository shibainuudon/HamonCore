...
static_assert(hamon::is_same<bool, decltype(hamon::isnan(0.0f))>::value, "");
static_assert(hamon::is_same<bool, decltype(hamon::isnan(0.0 ))>::value, "");
static_assert(hamon::is_same<bool, decltype(hamon::isnan(0.0l))>::value, "");
static_assert(hamon::is_same<bool, decltype(hamon::isnan(0   ))>::value, "");
