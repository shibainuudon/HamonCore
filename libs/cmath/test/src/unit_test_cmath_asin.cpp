...
static_assert(std::is_same<float,       decltype(hamon::asin(0.0f))>::value, "");
static_assert(std::is_same<float,       decltype(hamon::asinf(0.0f))>::value, "");
static_assert(std::is_same<double,      decltype(hamon::asin(0.0 ))>::value, "");
static_assert(std::is_same<double,      decltype(hamon::asin(0   ))>::value, "");
static_assert(std::is_same<long double, decltype(hamon::asin(0.0l))>::value, "");
static_assert(std::is_same<long double, decltype(hamon::asinl(0.0l))>::value, "");
