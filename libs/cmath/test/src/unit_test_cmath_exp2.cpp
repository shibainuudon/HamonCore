...
static_assert(hamon::is_same<float,       decltype(hamon::exp2(0.0f))>::value, "");
static_assert(hamon::is_same<float,       decltype(hamon::exp2f(0.0f))>::value, "");
static_assert(hamon::is_same<double,      decltype(hamon::exp2(0.0 ))>::value, "");
static_assert(hamon::is_same<double,      decltype(hamon::exp2(0   ))>::value, "");
static_assert(hamon::is_same<long double, decltype(hamon::exp2(0.0l))>::value, "");
