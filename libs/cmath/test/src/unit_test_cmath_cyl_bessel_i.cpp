...
//	HAMON_CXX14_CONSTEXPR_EXPECT_NEAR(11.301921952136325,  (double)hamon::cyl_bessel_i(T1(0.0), T2(4.0)), error);
	...
	static testcase const testcases[] =
	{
		...
		{0.0000000000000000, T1(1.0 / 3.0), 0.00},
		{0.5665068655780866, T1(1.0 / 3.0), 0.25},
		{0.7389731564251186, T1(1.0 / 3.0), 0.50},
		{0.8953232036583681, T1(1.0 / 3.0), 0.75},
		{1.0646313978895283, T1(1.0 / 3.0), 1.00},
		{1.2623776732605250, T1(1.0 / 3.0), 1.25},
		{1.5014290000224382, T1(1.0 / 3.0), 1.50},
		{1.7951195525946040, T1(1.0 / 3.0), 1.75},
		{2.1587825813728614, T1(1.0 / 3.0), 2.00},
		{2.6109134564811405, T1(1.0 / 3.0), 2.25},
		{3.1743242297241938, T1(1.0 / 3.0), 2.50},
		{3.8774551722182093, T1(1.0 / 3.0), 2.75},
		{4.7559569371646946, T1(1.0 / 3.0), 3.00},
		{5.8546499652731825, T1(1.0 / 3.0), 3.25},
		{7.2299798619171129, T1(1.0 / 3.0), 3.50},
		{8.9531114355506318, T1(1.0 / 3.0), 3.75},
		{11.113838389991479, T1(1.0 / 3.0), 4.00},
		{13.825531136529117, T1(1.0 / 3.0), 4.25},
		{17.231403968478318, T1(1.0 / 3.0), 4.50},
		{21.512458099556554, T1(1.0 / 3.0), 4.75},
		{26.897553069268362, T1(1.0 / 3.0), 5.00},
		...
		{0.0000000000000000, T1(2.0 / 3.0), 0.00},
		{0.2795369061320044, T1(2.0 / 3.0), 0.25},
		{0.4562832311355689, T1(2.0 / 3.0), 0.50},
		{0.6259456983818262, T1(2.0 / 3.0), 0.75},
		{0.8075212886061297, T1(2.0 / 3.0), 1.00},
		{1.0139484513577173, T1(2.0 / 3.0), 1.25},
		{1.2572918396962993, T1(2.0 / 3.0), 1.50},
		{1.5505806938325581, T1(2.0 / 3.0), 1.75},
		{1.9089492968236210, T1(2.0 / 3.0), 2.00},
		{2.3506463490300340, T1(2.0 / 3.0), 2.25},
		{2.8981161894224896, T1(2.0 / 3.0), 2.50},
		{3.5792654911068724, T1(2.0 / 3.0), 2.75},
		{4.4290087213549514, T1(2.0 / 3.0), 3.00},
		{5.4911895720097705, T1(2.0 / 3.0), 3.25},
		{6.8209918044137305, T1(2.0 / 3.0), 3.50},
		{8.4879784249619785, T1(2.0 / 3.0), 3.75},
		{10.579932774013004, T1(2.0 / 3.0), 4.00},
		{13.207720355482458, T1(2.0 / 3.0), 4.25},
		{16.511448404200543, T1(2.0 / 3.0), 4.50},
		{20.668274532832392, T1(2.0 / 3.0), 4.75},
		{25.902310583215122, T1(2.0 / 3.0), 5.00},
		...
		{0.0000000000000000,     T1(1.0 / 3.0),   0.0},
		{26.897553069268362,     T1(1.0 / 3.0),   5.0},
		{2799.2396097056790,     T1(1.0 / 3.0),  10.0},
		{338348.63146593666,     T1(1.0 / 3.0),  15.0},
		{43434263.927938424,     T1(1.0 / 3.0),  20.0},
		{5761474759.6213636,     T1(1.0 / 3.0),  25.0},
		{780201111830.30237,     T1(1.0 / 3.0),  30.0},
		{107166066959051.91,     T1(1.0 / 3.0),  35.0},
		{14873836574083762.,     T1(1.0 / 3.0),  40.0},
		{2.0808143020217085e+18, T1(1.0 / 3.0),  45.0},
		{2.9292639365644226e+20, T1(1.0 / 3.0),  50.0},
		{4.1445621624120489e+22, T1(1.0 / 3.0),  55.0},
		{5.8885758374365916e+24, T1(1.0 / 3.0),  60.0},
		{8.3958047021083941e+26, T1(1.0 / 3.0),  65.0},
		{1.2006287819446431e+29, T1(1.0 / 3.0),  70.0},
		{1.7213548977150022e+31, T1(1.0 / 3.0),  75.0},
		{2.4734492458444449e+33, T1(1.0 / 3.0),  80.0},
		{3.5611354547857122e+35, T1(1.0 / 3.0),  85.0},
		{5.1360491295551848e+37, T1(1.0 / 3.0),  90.0},
		{7.4189629097600431e+39, T1(1.0 / 3.0),  95.0},
		{1.0731523308358370e+42, T1(1.0 / 3.0), 100.0},
		...
		{0.0000000000000000,     T1(2.0 / 3.0),   0.0},
		{25.902310583215122,     T1(2.0 / 3.0),   5.0},
		{2750.4090423459315,     T1(2.0 / 3.0),  10.0},
		{334476.98138574377,     T1(2.0 / 3.0),  15.0},
		{43064361.686912313,     T1(2.0 / 3.0),  20.0},
		{5722397441.9603882,     T1(2.0 / 3.0),  25.0},
		{775804343498.02661,     T1(2.0 / 3.0),  30.0},
		{106649495512800.88,     T1(2.0 / 3.0),  35.0},
		{14811199896983754.,     T1(2.0 / 3.0),  40.0},
		{2.0730345814356961e+18, T1(2.0 / 3.0),  45.0},
		{2.9194166755257467e+20, T1(2.0 / 3.0),  50.0},
		{4.1319059569935374e+22, T1(2.0 / 3.0),  55.0},
		{5.8721031476386222e+24, T1(2.0 / 3.0),  60.0},
		{8.3741368248217830e+26, T1(2.0 / 3.0),  65.0},
		{1.1977528777008688e+29, T1(2.0 / 3.0),  70.0},
		{1.7175081240014333e+31, T1(2.0 / 3.0),  75.0},
		{2.4682690458513916e+33, T1(2.0 / 3.0),  80.0},
		{3.5541181975850724e+35, T1(2.0 / 3.0),  85.0},
		{5.1264933963228892e+37, T1(2.0 / 3.0),  90.0},
		{7.4058894880134064e+39, T1(2.0 / 3.0),  95.0},
		{1.0713562154788124e+42, T1(2.0 / 3.0), 100.0},
