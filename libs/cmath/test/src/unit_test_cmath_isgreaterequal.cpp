...
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0f, 0.0f))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0f, 0.0 ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0f, 0.0l))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0f, 0   ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0 , 0.0f))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0 , 0.0 ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0 , 0.0l))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0 , 0   ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0l, 0.0f))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0l, 0.0 ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0l, 0.0l))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0.0l, 0   ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0   , 0.0f))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0   , 0.0 ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0   , 0.0l))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isgreaterequal(0   , 0   ))>::value, "");
