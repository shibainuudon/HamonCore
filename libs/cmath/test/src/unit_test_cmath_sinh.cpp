...
void SinhTestFloat()
{
	...
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::iszero (hamon::sinh(T(+0.0))));
	HAMON_CXX11_CONSTEXPR_EXPECT_FALSE(hamon::signbit(hamon::sinh(T(+0.0))));
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::iszero (hamon::sinh(T(-0.0))));
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::signbit(hamon::sinh(T(-0.0))));
