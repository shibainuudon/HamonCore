...
void ScalbnTestFloat(void)
{
	...
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::iszero (hamon::scalbn(T(+0.0), 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_FALSE(hamon::signbit(hamon::scalbn(T(+0.0), 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::iszero (hamon::scalbn(T(-0.0), 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::signbit(hamon::scalbn(T(-0.0), 1)));
