...
void ScalblnTestFloat(void)
{
	...
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::iszero (hamon::scalbln(T(+0.0), 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_FALSE(hamon::signbit(hamon::scalbln(T(+0.0), 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::iszero (hamon::scalbln(T(-0.0), 1)));
	HAMON_CXX11_CONSTEXPR_EXPECT_TRUE (hamon::signbit(hamon::scalbln(T(-0.0), 1)));
