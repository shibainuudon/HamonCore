...
static_assert(std::is_same<float,       decltype(hamon::ceil(0.0f))>::value, "");
static_assert(std::is_same<float,       decltype(hamon::ceilf(0.0f))>::value, "");
static_assert(std::is_same<double,      decltype(hamon::ceil(0.0 ))>::value, "");
static_assert(std::is_same<double,      decltype(hamon::ceil(0   ))>::value, "");
static_assert(std::is_same<long double, decltype(hamon::ceil(0.0l))>::value, "");
static_assert(std::is_same<long double, decltype(hamon::ceill(0.0l))>::value, "");
