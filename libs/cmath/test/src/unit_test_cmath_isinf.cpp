...
static_assert(std::is_same<bool, decltype(hamon::isinf(0.0f))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isinf(0.0 ))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isinf(0.0l))>::value, "");
static_assert(std::is_same<bool, decltype(hamon::isinf(0   ))>::value, "");
