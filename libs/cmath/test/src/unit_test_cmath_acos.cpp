...
static_assert(std::is_same<float,       decltype(hamon::acos(0.0f))>::value, "");
static_assert(std::is_same<float,       decltype(hamon::acosf(0.0f))>::value, "");
static_assert(std::is_same<double,      decltype(hamon::acos(0.0 ))>::value, "");
static_assert(std::is_same<double,      decltype(hamon::acos(0   ))>::value, "");
static_assert(std::is_same<long double, decltype(hamon::acos(0.0l))>::value, "");
static_assert(std::is_same<long double, decltype(hamon::acosl(0.0l))>::value, "");
