...
static_assert(hamon::is_same<bool, decltype(hamon::is_odd(0.0f))>::value, "");
static_assert(hamon::is_same<bool, decltype(hamon::is_odd(0.0 ))>::value, "");
static_assert(hamon::is_same<bool, decltype(hamon::is_odd(0.0l))>::value, "");
static_assert(hamon::is_same<bool, decltype(hamon::is_odd(0   ))>::value, "");
