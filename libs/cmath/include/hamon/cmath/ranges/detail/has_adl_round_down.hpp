...
private:
	template <typename U1, typename U2,
		...
		>,
		typename S = decltype(round_down(hamon::declval<U1 const&>(), hamon::declval<U2 const&>())),
...
template <typename T1, typename T2>
HAMON_CONCEPT_OR_BOOL has_adl_round_down = has_adl_round_down_impl<T1, T2>::type::value;
