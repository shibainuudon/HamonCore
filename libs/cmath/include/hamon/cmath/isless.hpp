...
isless_impl_ct(FloatType x, FloatType y) HAMON_NOEXCEPT
{
...
#elif HAMON_HAS_BUILTIN(__builtin_isless)
	return hamon::is_constant_evaluated() ? isless_impl_ct(x, y) : __builtin_isless(x, y);
#else
	return isless_impl_ct(x, y);
#endif
}
