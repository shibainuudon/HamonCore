/**
 *	@file	unit_test_list_push_back.cpp
 *
...
LIST_TEST_CONSTEXPR bool test()
{
	...
	{
		List v;
		static_assert(hamon::is_same<decltype(v.push_back(hamon::declval<T const&>())), void>::value, "");
		static_assert(hamon::is_same<decltype(v.push_back(hamon::declval<T&&>())), void>::value, "");
