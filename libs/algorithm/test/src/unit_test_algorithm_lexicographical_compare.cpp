...
GTEST_TEST(AlgorithmTest, LexicographicalCompareTest)
{
	...
	HAMON_CONSTEXPR_OR_CONST int a3[] {0,1,1};
	HAMON_CONSTEXPR_OR_CONST int a4[] {2,1,2};
	HAMON_CONSTEXPR_OR_CONST int a5[] {0,1};
	HAMON_CONSTEXPR_OR_CONST int a6[] {0,1,2,3};

	HAMON_CONSTEXPR_OR_CONST std::array<int, 3> a7{{0, 1, 2}};
	HAMON_CONSTEXPR_OR_CONST std::array<int, 3> a8{{1, 1, 2}};
	HAMON_CONSTEXPR_OR_CONST std::array<int, 2> a9{{0, 1}};
	HAMON_CONSTEXPR_OR_CONST std::array<int, 4> a10{{0, 1, 2, 3}};
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_FALSE(hamon::lexicographical_compare(
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE (hamon::lexicographical_compare(
	...
	HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::lexicographical_compare(
		hamon::begin(a1), hamon::end(a1), hamon::begin(a7), hamon::end(a7)));

	HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::lexicographical_compare(
