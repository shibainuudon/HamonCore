...
{
	{
		...
		HAMON_STATIC_CONSTEXPR std::array<int, 3> c  {{1,2,4}};
		HAMON_STATIC_CONSTEXPR int                d[] {2,4,6};
		HAMON_STATIC_CONSTEXPR std::array<int, 3> e  {{3,5,7}};
		...
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(c), hamon::end(c)));
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(c), hamon::end(c), pred1));
		HAMON_CXX14_CONSTEXPR_EXPECT_TRUE (hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(d), hamon::end(d)));
		HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(e), hamon::end(e)));
	}
	{
		HAMON_STATIC_CONSTEXPR std::array<int, 5> a  {{10,20,30,40,50}};
		HAMON_STATIC_CONSTEXPR std::array<int, 5> b  {{10,20,30,40,50}};
		HAMON_STATIC_CONSTEXPR int                c[] {10,15,20};
		HAMON_STATIC_CONSTEXPR std::array<int, 2> d  {{ 9,10}};
		HAMON_STATIC_CONSTEXPR int                e[] {51};
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(b), hamon::end(b)));
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(b), hamon::end(b), pred1));
		HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(c), hamon::end(c)));
		HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(c), hamon::end(c), pred1));
		HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(d), hamon::end(d)));
		HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::includes(hamon::begin(a), hamon::end(a), hamon::begin(e), hamon::end(e)));
	}
	{
