...
GTEST_TEST(AlgorithmTest, AllOfTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_FALSE(hamon::all_of(hamon::begin(a1), hamon::end(a1), pred1));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE (hamon::all_of(hamon::begin(a1), hamon::end(a1), pred2));
	HAMON_CXX14_CONSTEXPR_EXPECT_FALSE(hamon::all_of(hamon::begin(a1), hamon::end(a1), pred3()));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE (hamon::all_of(hamon::begin(a1), hamon::end(a1), pred4()));

	HAMON_STATIC_CONSTEXPR std::array<int, 8> a2{{2, 4, 4, 8, 6, 4, 0, 6}};
	HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::all_of(hamon::begin(a2), hamon::end(a2), pred1));
	HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::all_of(hamon::begin(a2), hamon::end(a2), pred2));
	HAMON_CXX17_CONSTEXPR_EXPECT_TRUE (hamon::all_of(hamon::begin(a2), hamon::end(a2), pred3()));
	HAMON_CXX17_CONSTEXPR_EXPECT_FALSE(hamon::all_of(hamon::begin(a2), hamon::end(a2), pred4()));
