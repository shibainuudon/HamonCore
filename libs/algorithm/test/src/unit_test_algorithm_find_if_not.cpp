...
GTEST_TEST(AlgorithmTest, FindIfNotTest)
{
	...
	{
		HAMON_CXX17_CONSTEXPR_OR_CONST auto it = hamon::find_if_not(hamon::begin(a2), hamon::end(a2), pred1);
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE(it == hamon::begin(a2));
	}
	{
		HAMON_CXX17_CONSTEXPR_OR_CONST auto it = hamon::find_if_not(hamon::begin(a2), hamon::end(a2), pred2);
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE(it == hamon::end(a2));
	}
	{
		HAMON_CXX17_CONSTEXPR_OR_CONST auto it = hamon::find_if_not(hamon::begin(a2), hamon::end(a2), pred3());
		HAMON_CXX17_CONSTEXPR_EXPECT_TRUE(it == hamon::begin(a2));
	}
	{
		HAMON_CXX17_CONSTEXPR_OR_CONST auto it = hamon::find_if_not(hamon::begin(a2), hamon::end(a2), pred4());
