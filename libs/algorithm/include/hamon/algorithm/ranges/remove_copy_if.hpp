...
#ifndef HAMON_ALGORITHM_RANGES_REMOVE_COPY_IF_HPP
#define HAMON_ALGORITHM_RANGES_REMOVE_COPY_IF_HPP
...
#endif
	HAMON_CXX14_CONSTEXPR remove_copy_if_result<Iter, Out>
	operator()(
...
HAMON_INLINE_VAR HAMON_CONSTEXPR remove_copy_if_fn remove_copy_if{};
...
#endif // HAMON_ALGORITHM_RANGES_REMOVE_COPY_IF_HPP
