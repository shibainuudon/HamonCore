...
#ifndef HAMON_ALGORITHM_RANGES_SORT_HPP
#define HAMON_ALGORITHM_RANGES_SORT_HPP
...
struct sort_fn
{
		...
		hamon::sortable<Iter, Comp, Proj>)
	{
		...
		hamon::sort(hamon::move(first), lasti,
...
HAMON_INLINE_VAR HAMON_CONSTEXPR sort_fn sort{};
...
#endif // HAMON_ALGORITHM_RANGES_SORT_HPP
