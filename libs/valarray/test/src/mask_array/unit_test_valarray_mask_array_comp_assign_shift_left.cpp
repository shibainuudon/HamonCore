/**
 *	@file	unit_test_valarray_mask_array_comp_assign_shift_left.cpp
 *
 *	@brief	operator<<= のテスト
 *
...
namespace mask_array_comp_assign_shift_left_test
{
...
GTEST_TEST(ValArrayTest, MaskArrayCompAssignShiftLeftTest)
{
