/**
 *	@file	unit_test_valarray_mask_array_comp_assign_shift_right.cpp
 *
 *	@brief	operator>>= のテスト
 *
...
namespace mask_array_comp_assign_shift_right_test
{
...
GTEST_TEST(ValArrayTest, MaskArrayCompAssignShiftRightTest)
{
