/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_div.cpp
 *
 *	@brief	operator/= のテスト
 *
...
namespace indirect_array_comp_assign_div_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignDivTest)
{
