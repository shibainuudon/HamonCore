/**
 *	@file	unit_test_valarray_indirect_array_assign_indirect_array.cpp
 *
 *	@brief	operator= のテスト
 *
...
namespace indirect_array_assign_indirect_array_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayAssignIndirectArrayTest)
{
