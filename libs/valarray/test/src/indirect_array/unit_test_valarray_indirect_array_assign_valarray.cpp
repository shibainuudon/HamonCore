/**
 *	@file	unit_test_valarray_indirect_array_assign_valarray.cpp
 *
 *	@brief	operator= のテスト
 *
...
namespace indirect_array_assign_valarray_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayAssignValarrayTest)
{
