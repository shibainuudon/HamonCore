/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_shift_right.cpp
 *
 *	@brief	operator>>= のテスト
 *
...
namespace indirect_array_comp_assign_shift_right_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignShiftRightTest)
{
