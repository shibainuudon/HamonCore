/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_xor.cpp
 *
 *	@brief	operator^= のテスト
 *
...
namespace indirect_array_comp_assign_xor_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignXorTest)
{
