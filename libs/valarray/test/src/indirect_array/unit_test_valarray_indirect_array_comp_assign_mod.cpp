/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_mod.cpp
 *
 *	@brief	operator%= のテスト
 *
...
namespace indirect_array_comp_assign_mod_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignModTest)
{
