/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_sub.cpp
 *
 *	@brief	operator-= のテスト
 *
...
namespace indirect_array_comp_assign_sub_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignSubTest)
{
