/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_shift_left.cpp
 *
 *	@brief	operator<<= のテスト
 *
...
namespace indirect_array_comp_assign_shift_left_test
{
...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	VERIFY(v1[24] == 786432);
	VERIFY(v1[25] == 25);
	VERIFY(v1[26] == 1703936);
	VERIFY(v1[27] == 3538944);
	VERIFY(v1[28] == 7340032);
	VERIFY(v1[29] == 29);
	VERIFY(v1[30] == 15728640);
	VERIFY(v1[31] == 32505856);
	VERIFY(v1[32] == 67108864);
	VERIFY(v1[33] == 33);
	VERIFY(v1[34] == 142606336);
	VERIFY(v1[35] == 293601280);
	VERIFY(v1[36] == 603979776);
	VERIFY(v1[37] == 37);
	VERIFY(v1[38] == 38);
	VERIFY(v1[39] == 39);
	VERIFY(v1[40] == 40);
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignShiftLeftTest)
{
