/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_mul.cpp
 *
 *	@brief	operator*= のテスト
 *
...
namespace indirect_array_comp_assign_mul_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignMulTest)
{
