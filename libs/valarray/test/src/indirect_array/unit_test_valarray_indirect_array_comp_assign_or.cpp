/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_or.cpp
 *
 *	@brief	operator|= のテスト
 *
...
namespace indirect_array_comp_assign_or_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignOrTest)
{
