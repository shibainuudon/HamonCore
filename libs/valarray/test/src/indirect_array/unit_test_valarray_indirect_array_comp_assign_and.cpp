/**
 *	@file	unit_test_valarray_indirect_array_comp_assign_and.cpp
 *
 *	@brief	operator&= のテスト
 *
...
namespace indirect_array_comp_assign_and_test
{
...
GTEST_TEST(ValArrayTest, IndirectArrayCompAssignAndTest)
{
