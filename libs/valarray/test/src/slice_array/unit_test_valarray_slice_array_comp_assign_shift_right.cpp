/**
 *	@file	unit_test_valarray_slice_array_comp_assign_shift_right.cpp
 *
 *	@brief	operator>>= のテスト
 *
...
namespace slice_array_comp_assign_shift_right_test
{
...
GTEST_TEST(ValArrayTest, SliceArrayCompAssignShiftRightTest)
{
