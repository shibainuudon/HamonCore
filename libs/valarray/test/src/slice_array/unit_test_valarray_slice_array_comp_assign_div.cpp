/**
 *	@file	unit_test_valarray_slice_array_comp_assign_div.cpp
 *
 *	@brief	operator/= のテスト
 *
...
namespace slice_array_comp_assign_div_test
{
...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	VERIFY(v1[8] == 8);
	VERIFY(v1[9] == 9);
	VERIFY(v1[10] == T(10) / T(-4));
	VERIFY(v1[11] == 11);
	VERIFY(v1[12] == 12);
	VERIFY(v1[13] == T(13) / T(-5));
	VERIFY(v1[14] == 14);
	VERIFY(v1[15] == 15);
...
GTEST_TEST(ValArrayTest, SliceArrayCompAssignDivTest)
{
