/**
 *	@file	unit_test_valarray_slice_array_comp_assign_shift_left.cpp
 *
 *	@brief	operator<<= のテスト
 *
...
namespace slice_array_comp_assign_shift_left_test
{
...
GTEST_TEST(ValArrayTest, SliceArrayCompAssignShiftLeftTest)
{
