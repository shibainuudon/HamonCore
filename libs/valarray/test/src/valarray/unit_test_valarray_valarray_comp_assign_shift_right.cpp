/**
 *	@file	unit_test_valarray_valarray_comp_assign_shift_right.cpp
 *
 *	@brief	operator>>= のテスト
 *
...
namespace valarray_comp_assign_shift_right_test
{
...
{
	hamon::valarray<T> va{64,256,768};
...
GTEST_TEST(ValArrayTest, ValarrayCompAssignShiftRightTest)
{
