/**
 *	@file	unit_test_valarray_valarray_comp_assign_div.cpp
 *
 *	@brief	operator/= のテスト
 *
...
namespace valarray_comp_assign_div_test
{
...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	{
		auto& t = (va /= hamon::valarray<T>{3,2,1});
		VERIFY(&t == &va);
	}
	VERIFY(va.size() == 3u);
	VERIFY(va[0] == T{12});
...
GTEST_TEST(ValArrayTest, ValarrayCompAssignDivTest)
{
