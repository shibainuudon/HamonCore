/**
 *	@file	unit_test_valarray_valarray_comparison_greater.cpp
 *
 *	@brief	operator+ のテスト
 *
...
namespace valarray_comparison_greater_test
{
...
GTEST_TEST(ValArrayTest, ValarrayComparisonGreaterTest)
{
