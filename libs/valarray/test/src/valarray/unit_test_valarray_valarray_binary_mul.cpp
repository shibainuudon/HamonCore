/**
 *	@file	unit_test_valarray_valarray_binary_mul.cpp
 *
 *	@brief	operator* のテスト
 *
...
namespace valarray_binary_mul_test
{
...
GTEST_TEST(ValArrayTest, ValarrayBinaryMulTest)
{
