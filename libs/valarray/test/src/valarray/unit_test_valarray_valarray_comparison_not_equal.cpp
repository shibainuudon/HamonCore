/**
 *	@file	unit_test_valarray_valarray_comparison_not_equal.cpp
 *
 *	@brief	operator+ のテスト
 *
...
namespace valarray_comparison_not_equal_test
{
...
GTEST_TEST(ValArrayTest, ValarrayComparisonNotEqualTest)
{
