/**
 *	@file	unit_test_valarray_valarray_binary_shift_right.cpp
 *
 *	@brief	operator>> のテスト
 *
...
namespace valarray_binary_shift_right_test
{
...
GTEST_TEST(ValArrayTest, ValarrayBinaryShiftRightTest)
{
