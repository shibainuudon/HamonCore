/**
 *	@file	unit_test_valarray_gslice_array_assign_valarray.cpp
 *
 *	@brief	operator= のテスト
 *
 *	// [gslice.array.assign]
...
namespace gslice_array_assign_valarray_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayAssignValarrayTest)
{
