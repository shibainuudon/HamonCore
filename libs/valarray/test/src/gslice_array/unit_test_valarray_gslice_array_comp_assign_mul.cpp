/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_mul.cpp
 *
 *	@brief	operator*= のテスト
 *
...
namespace gslice_array_comp_assign_mul_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignMulTest)
{
