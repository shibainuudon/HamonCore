/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_div.cpp
 *
 *	@brief	operator/= のテスト
 *
...
namespace gslice_array_comp_assign_div_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignDivTest)
{
