/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_add.cpp
 *
 *	@brief	operator+= のテスト
 *
...
namespace gslice_array_comp_assign_add_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignAddTest)
{
