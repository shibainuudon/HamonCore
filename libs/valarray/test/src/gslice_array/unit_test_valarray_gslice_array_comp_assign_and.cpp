/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_and.cpp
 *
 *	@brief	operator&= のテスト
 *
...
namespace gslice_array_comp_assign_and_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignAndTest)
{
