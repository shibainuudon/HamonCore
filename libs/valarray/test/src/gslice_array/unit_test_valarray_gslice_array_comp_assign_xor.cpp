/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_xor.cpp
 *
 *	@brief	operator^= のテスト
 *
...
namespace gslice_array_comp_assign_xor_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignXorTest)
{
