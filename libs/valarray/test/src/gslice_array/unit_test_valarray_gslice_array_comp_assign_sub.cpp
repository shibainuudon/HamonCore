/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_sub.cpp
 *
 *	@brief	operator-= のテスト
 *
...
namespace gslice_array_comp_assign_sub_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignSubTest)
{
