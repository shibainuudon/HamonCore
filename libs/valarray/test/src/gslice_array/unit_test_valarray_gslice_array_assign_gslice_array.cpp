/**
 *	@file	unit_test_valarray_gslice_array_assign_gslice_array.cpp
 *
 *	@brief	operator= のテスト
 *
 *	// [gslice.array.assign]
...
namespace gslice_array_assign_gslice_array_test
{
...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	hamon::gslice gs1(3, sizes(sz, sizeof(sz) / sizeof(sz[0])), strides(st, sizeof(st) / sizeof(st[0])));
	hamon::gslice gs2(3, sizes(sz, sizeof(sz) / sizeof(sz[0])), strides(st, sizeof(st) / sizeof(st[0])));
...
GTEST_TEST(ValArrayTest, GsliceArrayAssignGsliceArrayTest)
{
