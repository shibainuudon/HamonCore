/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_shift_left.cpp
 *
 *	@brief	operator<<= のテスト
 *
...
namespace gslice_array_comp_assign_shift_left_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignShiftLeftTest)
{
