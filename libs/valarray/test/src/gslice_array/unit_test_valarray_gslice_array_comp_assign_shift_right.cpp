/**
 *	@file	unit_test_valarray_gslice_array_comp_assign_shift_right.cpp
 *
 *	@brief	operator>>= のテスト
 *
...
namespace gslice_array_comp_assign_shift_right_test
{
...
GTEST_TEST(ValArrayTest, GsliceArrayCompAssignShiftRightTest)
{
