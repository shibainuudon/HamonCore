...
HAMON_CXX14_CONSTEXPR void
atomic_store_add_impl(T* ptr, U val, hamon::memory_order order, hamon::detail::overload_priority<0>)
{
...
template <typename T, typename U>
HAMON_CXX14_CONSTEXPR void atomic_store_add(T* ptr, U val, hamon::memory_order order)
{
...
template <typename T, typename U>
HAMON_CXX14_CONSTEXPR void atomic_store_add(T* ptr, U val)
{
