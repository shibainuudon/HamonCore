/**
 *	@file	unit_test_tuple_tuple_ctor_alloc_pair_rref.cpp
 *
...
namespace ctor_alloc_pair_rref_test
{
...
inline HAMON_CXX14_CONSTEXPR bool test()
{
	...
	}
	{
		...
		hamon::tuple<ExplicitNoAlloc, ImplicitFirstAlloc> const t2(hamon::allocator_arg, a, hamon::move(t1));
	...
	}
	{
		...
		hamon::tuple<NoThrowFirstAlloc, NoThrowLastAlloc> const t2(hamon::allocator_arg, a, hamon::move(t1));
...
GTEST_TEST(TupleTest, CtorAllocPairRRefTest)
{
