/**
 *	@file	unit_test_tuple_tuple_ctor_alloc_tuple_like_ref.cpp
 *
...
namespace ctor_alloc_tuple_like_ref_test
{
...
inline HAMON_CXX14_CONSTEXPR bool test()
{
	...
	}
	{
		...
		hamon::tuple<ImplicitFirstAlloc, ImplicitLastAlloc, ImplicitNoAlloc> t2(hamon::allocator_arg, a, t1);
...
GTEST_TEST(TupleTest, CtorAllocTupleLikeRefTest)
{
