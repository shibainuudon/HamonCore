/**
 *	@file	unit_test_tuple_tuple_ctor_alloc_tuple_like_crref.cpp
 *
...
namespace ctor_alloc_tuple_like_crref_test
{
...
GTEST_TEST(TupleTest, CtorAllocTupleLikeCRRefTest)
{
	...
	}
	{
		...
		hamon::tuple<ImplicitFirstAlloc, ImplicitLastAlloc, ImplicitNoAlloc>  const t2(hamon::allocator_arg, a, hamon::move(t1));
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::tuple<> const t2(hamon::allocator_arg, a, hamon::move(t1));
		(void)t2;
	}
	{
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::tuple<ImplicitFirstAlloc, ImplicitLastAlloc, ImplicitNoAlloc>  const t2(hamon::allocator_arg, a, hamon::move(t1));
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::tuple<ExplicitFirstAlloc, int, ExplicitLastAlloc, ExplicitNoAlloc>  const t2(hamon::allocator_arg, a, hamon::move(t1));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(3, hamon::adl_get<0>(t2).n);
