/**
 *	@file	unit_test_tuple_tuple_ctor_alloc_pair_crref.cpp
 *
...
namespace ctor_alloc_pair_crref_test
{
...
GTEST_TEST(TupleTest, CtorAllocPairCRRefTest)
{
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::tuple<int, double> const t2(hamon::allocator_arg, a, hamon::move(t1));
	...
	}
	{
		...
		hamon::tuple<ExplicitFirstAlloc, ExplicitLastAlloc> const t2(hamon::allocator_arg, a, hamon::move(t1));
		EXPECT_EQ(3, hamon::adl_get<0>(t2).n);
		EXPECT_EQ(4, hamon::adl_get<1>(t2).n);
	}
	{
		HAMON_CXX11_CONSTEXPR hamon::pair<int, int> const t1(5, 6);
		HAMON_CXX11_CONSTEXPR hamon::tuple<ExplicitNoAlloc, ImplicitFirstAlloc> const t2(hamon::allocator_arg, a, hamon::move(t1));
	...
	}
	{
		...
		hamon::tuple<ImplicitLastAlloc, ImplicitNoAlloc> const t2(hamon::allocator_arg, a, hamon::move(t1));
		EXPECT_EQ(7, hamon::adl_get<0>(t2).n);
		EXPECT_EQ(8, hamon::adl_get<1>(t2).n);
	}
	{
		HAMON_CXX11_CONSTEXPR hamon::pair<int, int> const t1(9, 10);
		HAMON_CXX11_CONSTEXPR hamon::tuple<NoThrowFirstAlloc, NoThrowLastAlloc> const t2(hamon::allocator_arg, a, hamon::move(t1));
	...
	}
	{
		...
		hamon::tuple<NoThrowNoAlloc, int> const t2(hamon::allocator_arg, a, hamon::move(t1));
