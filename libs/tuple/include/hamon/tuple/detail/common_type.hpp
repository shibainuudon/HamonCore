...
requires
	...
	(hamon::tuple_size_v<TTuple> == hamon::tuple_size_v<UTuple>) &&		// [tuple.common.ref]3.4
...
struct tuple_common_type_impl<TTuple, UTuple,
	hamon::enable_if_t<
		...
		(hamon::tuple_size<TTuple>::value == hamon::tuple_size<UTuple>::value)	// [tuple.common.ref]3.4
	>,
