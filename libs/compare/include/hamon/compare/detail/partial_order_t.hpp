...
private:
	...
	HAMON_NOEXCEPT_DECLTYPE_RETURN(
		hamon::partial_ordering(partial_order(hamon::forward<T>(e), hamon::forward<U>(f))))
	...
	HAMON_NOEXCEPT_DECLTYPE_RETURN(
		hamon::partial_ordering(hamon::compare_three_way()(hamon::forward<T>(e), hamon::forward<U>(f))))
#endif
	...
	HAMON_NOEXCEPT_DECLTYPE_RETURN(
		hamon::partial_ordering(detail::weak_order_t{}(hamon::forward<T>(e), hamon::forward<U>(f))))
