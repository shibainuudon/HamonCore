/**
 *	@file	format_test_locale.hpp
 *
 *	@brief
 */

#ifndef HAMON_FORMAT_TEST_LOCALE_HPP
#define HAMON_FORMAT_TEST_LOCALE_HPP
...
void test_bool(TestFunction test)
{
...
template <class CharT, class TestFunction>
void test_integer(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
...
void test_floating_point_hex_lower_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_hex_upper_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_hex_lower_case_precision(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_hex_upper_case_precision(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_scientific_lower_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_scientific_upper_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_fixed_lower_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_fixed_upper_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_general_lower_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_general_upper_case(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_default(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point_default_precision(TestFunction test)
{
	std::locale loc = std::locale(std::locale(), new numpunct<CharT>());
	std::locale en_US = std::locale(LOCALE_en_US_UTF_8);
...
template <class F, class CharT, class TestFunction>
void test_floating_point(TestFunction test)
{
	test_floating_point_hex_lower_case<F, CharT>(test);
	test_floating_point_hex_upper_case<F, CharT>(test);
	test_floating_point_hex_lower_case_precision<F, CharT>(test);
	test_floating_point_hex_upper_case_precision<F, CharT>(test);

	test_floating_point_scientific_lower_case<F, CharT>(test);
	test_floating_point_scientific_upper_case<F, CharT>(test);

	test_floating_point_fixed_lower_case<F, CharT>(test);
	test_floating_point_fixed_upper_case<F, CharT>(test);

	test_floating_point_general_lower_case<F, CharT>(test);
	test_floating_point_general_upper_case<F, CharT>(test);

	test_floating_point_default<F, CharT>(test);
	test_floating_point_default_precision<F, CharT>(test);
}

}	// namespace locale_test

template <class CharT, class TestFunction>
void test_locale(TestFunction check)
{
	locale_test::test_bool<CharT>(check);
	locale_test::test_integer<CharT>(check);
	locale_test::test_floating_point<float, CharT>(check);
	locale_test::test_floating_point<double, CharT>(check);
	locale_test::test_floating_point<long double, CharT>(check);
}
...
#endif // HAMON_FORMAT_TEST_LOCALE_HPP
