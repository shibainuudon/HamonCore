/**
 *	@file	__indic_conjunct_break.hpp
 *
 *	@brief	__indic_conjunct_break の定義
 */

#ifndef HAMON_FORMAT___FORMAT___INDIC_CONJUNCT_BREAK_HPP
#define HAMON_FORMAT___FORMAT___INDIC_CONJUNCT_BREAK_HPP
...
// clang-format off
inline constexpr uint32_t __entries[403] =
{
    0x001801bd,
    0x00241819,
    0x002c88b1,
...
[[nodiscard]] constexpr
__property __get_property(const char32_t __code_point) noexcept
{
...
#endif // HAMON_FORMAT___FORMAT___INDIC_CONJUNCT_BREAK_HPP
