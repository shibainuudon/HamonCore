/**
 *	@file	__width_estimation_table.hpp
 *
 *	@brief	__width_estimation_table の定義
 */

#ifndef HAMON_FORMAT___FORMAT___WIDTH_ESTIMATION_TABLE_HPP
#define HAMON_FORMAT___FORMAT___WIDTH_ESTIMATION_TABLE_HPP
...
inline constexpr uint32_t __entries[110] =
{
...
__estimated_width(const char32_t __code_point) noexcept
{
...
#endif // HAMON_FORMAT___FORMAT___WIDTH_ESTIMATION_TABLE_HPP
