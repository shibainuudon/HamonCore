...
#include <hamon/format/detail/format_output_buffer.hpp>
...
using wformat_context = hamon::basic_format_context<
	hamon::back_insert_iterator<hamon::detail::format_output_buffer<wchar_t>>, wchar_t>;
