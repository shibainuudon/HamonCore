...
constexpr __format_spec::__column_width_result<_Iterator> __estimate_column_width_grapheme_clustering(
...
constexpr __format_spec::__column_width_result<_Iterator> __estimate_column_width(
...
constexpr __format_spec::__column_width_result<typename hamon::basic_string_view<_CharT>::const_iterator>
__estimate_column_width(hamon::basic_string_view<_CharT> __str, size_t __maximum, __format_spec::__column_width_rounding) noexcept
{
	...
	// need for rounding.
	size_t __width = hamon::min(__str.size(), __maximum);
