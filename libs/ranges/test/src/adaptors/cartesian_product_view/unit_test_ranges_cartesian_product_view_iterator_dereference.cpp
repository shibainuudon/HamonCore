/**
 *	@file	unit_test_ranges_cartesian_product_view_iterator_dereference.cpp
 *
 *	@brief	operator* のテスト
 *
...
GTEST_TEST(RangesTest, CartesianProductViewIteratorDereferenceTest)
{
