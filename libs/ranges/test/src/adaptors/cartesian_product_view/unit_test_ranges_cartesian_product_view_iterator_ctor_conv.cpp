/**
 *	@file	unit_test_ranges_cartesian_product_view_iterator_ctor_conv.cpp
 *
 *	@brief	変換コンストラクタのテスト
 *
...
HAMON_CXX14_CONSTEXPR bool test00()
{
	...
	}
	{
		...
		CV cv(v1, v2);
		CI it = cv.begin();
		VERIFY(*it == hamon::make_tuple(1, 4));
	}
	return true;
}
...
GTEST_TEST(RangesTest, CartesianProductViewIteratorCtorConvTest)
{
