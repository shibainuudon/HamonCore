/**
 *	@file	unit_test_ranges_as_const_view_size.cpp
 *
 *	@brief	size() のテスト
 *
...
HAMON_CXX14_CONSTEXPR bool test00()
{
	...
	// sized_range<V> && !sized_range<V const>
	{
		...
		static_assert(hamon::is_same<decltype(hamon::declval<CV&>().size()), long>::value, "");
	}
...
GTEST_TEST(RangesTest, AsConstViewSizeTest)
{
