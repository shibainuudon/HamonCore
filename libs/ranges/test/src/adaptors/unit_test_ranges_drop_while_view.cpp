...
HAMON_CXX14_CONSTEXPR bool test00_impl()
{
	...
	static_assert(hamon::ranges::sized_range<DWV> == hamon::sized_sentinel_for<S, I>, "");
	static_assert(hamon::ranges::approximately_sized_range<DWV> == hamon::sized_sentinel_for<S, I>, "");
	static_assert(hamon::ranges::output_range<DWV, T> == hamon::ranges::output_range<V, T>, "");
	static_assert(hamon::ranges::input_range<DWV> == hamon::ranges::input_range<V>, "");
	static_assert(hamon::ranges::forward_range<DWV> == hamon::ranges::forward_range<V>, "");
	static_assert(hamon::ranges::bidirectional_range<DWV> == hamon::ranges::bidirectional_range<V>, "");
	static_assert(hamon::ranges::random_access_range<DWV> == hamon::ranges::random_access_range<V>, "");
	...
	static_assert(hamon::ranges::viewable_range<DWV> == true, "");
