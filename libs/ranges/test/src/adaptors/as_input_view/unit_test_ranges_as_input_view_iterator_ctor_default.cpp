/**
 *	@file	unit_test_ranges_as_input_view_iterator_ctor_default.cpp
 *
...
{
	{
		...
		using I = hamon::ranges::iterator_t<AIV>;
...
GTEST_TEST(RangesTest, AsInputViewIteratorCtorDefaultTest)
{
