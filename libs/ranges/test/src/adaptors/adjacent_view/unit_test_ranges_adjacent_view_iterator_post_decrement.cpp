/**
 *	@file	unit_test_ranges_adjacent_view_iterator_post_decrement.cpp
 *
 *	@brief	後置デクリメントのテスト
 *
...
{
	{
		...
		auto t1 = it--;
		VERIFY(t1 != it);
		VERIFY(*t1 == hamon::make_tuple(3,4));
...
GTEST_TEST(RangesTest, AdjacentViewIteratorPostDecrementTest)
{
