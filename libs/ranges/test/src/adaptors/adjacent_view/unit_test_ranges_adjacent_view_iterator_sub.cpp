/**
 *	@file	unit_test_ranges_adjacent_view_iterator_sub.cpp
 *
 *	@brief	operator- のテスト
 *
...
{
	{
		...
		auto it2 = it1 - 1;
		auto it3 = it1 - 2;
		VERIFY(*it2 == hamon::make_tuple(2,3));
		VERIFY(*it3 == hamon::make_tuple(1,2));
		VERIFY((it1 - it1) ==  0);
		VERIFY((it1 - it2) ==  1);
		VERIFY((it1 - it3) ==  2);
		VERIFY((it3 - it1) == -2);
...
GTEST_TEST(RangesTest, AdjacentViewIteratorSubTest)
{
