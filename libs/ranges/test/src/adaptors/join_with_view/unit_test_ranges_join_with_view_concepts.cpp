...
void test0()
{
	...
	static_assert(hamon::ranges::sized_range<JWV>               == false, "");
	static_assert(hamon::ranges::approximately_sized_range<JWV> == false, "");
	static_assert(hamon::ranges::output_range<JWV, T>           ==
		(hamon::ranges::forward_range<V> &&
		 hamon::ranges::forward_range<IV>), "");
	static_assert(hamon::ranges::input_range<JWV>               == true, "");
	static_assert(hamon::ranges::forward_range<JWV>             ==
		(hamon::ranges::forward_range<V> &&
		 hamon::ranges::forward_range<IV>), "");
	static_assert(hamon::ranges::bidirectional_range<JWV> ==
		(hamon::ranges::bidirectional_range<V> &&
		 ...
		 hamon::ranges::common_range<Pattern>), "");
	static_assert(hamon::ranges::random_access_range<JWV>       == false, "");
	...
	static_assert(hamon::ranges::common_range<JWV>              ==
		(hamon::ranges::forward_range<V> &&
		 ...
		 hamon::ranges::common_range<IV>), "");
	static_assert(hamon::ranges::viewable_range<JWV>            == true, "");
	static_assert(hamon::ranges::view<JWV>                      == true, "");
	static_assert(hamon::ranges::constant_range<JWV>            == false, "");
}
...
GTEST_TEST(RangesTest, JoinWithViewConceptsTest)
{
...
#if 0
	{
		...
		static_assert(!hamon::ranges::sized_range<JWV>, "");
		static_assert(!hamon::ranges::approximately_sized_range<JWV>, "");
		static_assert(!hamon::ranges::output_range<JWV, T>, "");
		static_assert( hamon::ranges::input_range<JWV>, "");
		static_assert(!hamon::ranges::forward_range<JWV>, "");
		static_assert(!hamon::ranges::bidirectional_range<JWV>, "");
		static_assert(!hamon::ranges::random_access_range<JWV>, "");
		static_assert(!hamon::ranges::constant_range<JWV>, "");
		static_assert(!hamon::ranges::common_range<JWV>, "");
		static_assert( hamon::ranges::viewable_range<JWV>, "");
		static_assert( hamon::ranges::view<JWV>, "");
		static_assert(!hamon::ranges::constant_range<JWV>, "");
	}
	{
		using T = int;
