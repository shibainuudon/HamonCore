...
{
	{
		...
		static_assert( hamon::ranges::range<AV>, "");
		static_assert(!hamon::ranges::borrowed_range<AV>, "");
		static_assert(!hamon::ranges::sized_range<AV>, "");
		...
		static_assert(!hamon::ranges::random_access_range<AV>, "");
		static_assert(!hamon::ranges::contiguous_range<AV>, "");
		static_assert(!hamon::ranges::common_range<AV>, "");
		static_assert( hamon::ranges::viewable_range<AV>, "");
