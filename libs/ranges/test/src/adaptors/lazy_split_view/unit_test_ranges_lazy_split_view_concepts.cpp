...
void test()
{
	...
	static_assert(hamon::ranges::random_access_range<LSV> == false, "");
	...
	static_assert(hamon::ranges::viewable_range<LSV> == true, "");
	static_assert(hamon::ranges::view<LSV> == true, "");
	...
	static_assert(has_cend<LSV const&>::value          == hamon::ranges::input_range<LSV const>, "");
	...
	static_assert(hamon::ranges::random_access_range<IV>       == false, "");
