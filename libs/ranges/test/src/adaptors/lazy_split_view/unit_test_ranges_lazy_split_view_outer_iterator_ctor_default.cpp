/**
 *	@file	unit_test_ranges_lazy_split_view_outer_iterator_ctor_default.cpp
 *
...
{
namespace outer_iterator_ctor_default_test
{
...
HAMON_CXX14_CONSTEXPR bool test00()
{
	...
	//static_assert(hamon::is_same<I, typename RV::outer_iterator<true>>::value, "");
...
HAMON_CXX14_CONSTEXPR bool test01()
{
	...
	using RV = hamon::ranges::lazy_split_view<V, P>;
	using I = hamon::ranges::iterator_t<RV>;
	//static_assert(hamon::is_same<I, typename RV::outer_iterator<false>>::value, "");
	static_assert(hamon::is_default_constructible<I>::value, "");
...
GTEST_TEST(RangesTest, LazySplitViewOuterIteratorCtorDefaultTest)
{
