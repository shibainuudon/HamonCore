/**
 *	@file	unit_test_ranges_common_view_ctor_base.cpp
 *
...
#if defined(HAMON_HAS_CXX17_DEDUCTION_GUIDES)
	hamon::ranges::common_view cv{hamon::move(r)};
	static_assert(hamon::is_same<decltype(cv), CV>::value, "");
#else
	CV cv{hamon::move(r)};
#endif
...
GTEST_TEST(RangesTest, CommonViewCtorBaseTest)
{
