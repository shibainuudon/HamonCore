...
static_assert(hamon::tuple_size<SR1>::value == 2, "");
static_assert(hamon::tuple_size<SR2>::value == 2, "");
static_assert(hamon::tuple_size<SR3>::value == 2, "");

static_assert(hamon::tuple_size<SR1 const>::value == 2, "");
static_assert(hamon::tuple_size<SR2 const>::value == 2, "");
static_assert(hamon::tuple_size<SR3 const>::value == 2, "");
