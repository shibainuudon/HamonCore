...
HAMON_CXX14_CONSTEXPR bool test01()
{
	...
	static_assert(hamon::same_as<decltype(hamon::ranges::crend(a)), hamon::reverse_iterator<int const*>>, "");
...
HAMON_CXX14_CONSTEXPR bool test03()
{
	...
	static_assert(hamon::same_as<decltype(hamon::ranges::crend(r)), const int*>, "");
	static_assert(hamon::same_as<decltype(hamon::ranges::crend(cr)), const int*>, "");
...
HAMON_CXX14_CONSTEXPR bool test04()
{
	...
	static_assert(hamon::same_as<decltype(hamon::ranges::crend(r)), hamon::basic_const_iterator<int*>>, "");
	static_assert(hamon::same_as<decltype(hamon::ranges::crend(cr)), hamon::basic_const_iterator<int*>>, "");
