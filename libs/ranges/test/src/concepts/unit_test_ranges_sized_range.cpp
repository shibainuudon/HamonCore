...
HAMON_RANGES_SIZED_RANGE_TEST(true,  hamon::unordered_set<int>);
HAMON_RANGES_SIZED_RANGE_TEST(true,  hamon::unordered_multiset<int>);
HAMON_RANGES_SIZED_RANGE_TEST(true,  hamon::string);
