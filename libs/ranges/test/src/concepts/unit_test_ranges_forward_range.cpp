...
HAMON_RANGES_FORWARD_RANGE_TEST(true,  hamon::unordered_set<int>);
HAMON_RANGES_FORWARD_RANGE_TEST(true,  hamon::unordered_multiset<int>);
HAMON_RANGES_FORWARD_RANGE_TEST(true,  hamon::string);
