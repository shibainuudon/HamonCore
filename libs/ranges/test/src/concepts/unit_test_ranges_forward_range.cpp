...
HAMON_RANGES_FORWARD_RANGE_TEST(true,  std::array<int, 2>);
...
HAMON_RANGES_FORWARD_RANGE_TEST(true,  std::set<int>);
HAMON_RANGES_FORWARD_RANGE_TEST(true,  std::multiset<int>);
