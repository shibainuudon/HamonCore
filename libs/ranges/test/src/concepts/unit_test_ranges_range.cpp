...
HAMON_RANGES_RANGE_TEST(true,  hamon::deque<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::list<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::forward_list<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::set<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::multiset<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::unordered_set<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::unordered_multiset<int>);
HAMON_RANGES_RANGE_TEST(true,  hamon::string);
