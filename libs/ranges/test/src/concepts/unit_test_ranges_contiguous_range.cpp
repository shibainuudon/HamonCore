...
HAMON_RANGES_CONTIGUOUS_RANGE_TEST(false, hamon::unordered_set<int>);
HAMON_RANGES_CONTIGUOUS_RANGE_TEST(false, hamon::unordered_multiset<int>);
HAMON_RANGES_CONTIGUOUS_RANGE_TEST(true,  hamon::string);
#endif
