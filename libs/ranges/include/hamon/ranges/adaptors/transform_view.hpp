...
private:
	...
	public:
		...
		template <typename I2 = I,
			typename = hamon::enable_if_t<Const &&
				hamon::convertible_to<hamon::ranges::iterator_t<V>, I2>>>
		HAMON_CXX11_CONSTEXPR
	...
	public:
		...
		template <typename Sent2 = Sent,
			typename = hamon::enable_if_t<Const &&
				hamon::convertible_to<hamon::ranges::sentinel_t<V>, Sent2>>>
		HAMON_CXX11_CONSTEXPR
	...
	private:
		...
		template <bool OtherConst,
			...
			typename = hamon::enable_if_t<hamon::sentinel_for<Sent, I2>>>
		HAMON_NODISCARD friend HAMON_CXX11_CONSTEXPR	// nodiscard as an extension
...
public:
	HAMON_NODISCARD HAMON_CXX14_CONSTEXPR		// nodiscard as an extension
	auto end()
	HAMON_NOEXCEPT_IF_EXPR(end_impl(hamon::detail::overload_priority<1>{}))	// noexcept as an extension
