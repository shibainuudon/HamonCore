...
template <
	...
	typename T, hamon::size_t N, hamon::size_t M, hamon::size_t L,
	typename Vector = typename Matrix<T, 1, L>::value_type,
	hamon::size_t... Ks
>
HAMON_NODISCARD inline HAMON_CONSTEXPR T
mul_matrix_impl_3(Matrix<T, N, L> const& lhs, Matrix<T, L, M> const& rhs, hamon::size_t I, hamon::size_t J, hamon::index_sequence<Ks...>) HAMON_NOEXCEPT
{
...
mul_matrix_impl_2(Matrix<T, N, L> const& lhs, Matrix<T, L, M> const& rhs, hamon::size_t I, hamon::index_sequence<Js...>) HAMON_NOEXCEPT
{
...
template <
	template <typename, hamon::size_t, hamon::size_t> class Matrix,
	typename T1, typename T2, hamon::size_t N, hamon::size_t M, hamon::size_t L,
