/**
 *	@file	unit_test_qvm_vector_plus.cpp
 *
 *	@brief	operator+のテスト
 */
...
template <typename T>
inline HAMON_CXX14_CONSTEXPR bool Vector2PlusTest()
{
...
template <typename T>
inline HAMON_CXX14_CONSTEXPR bool Vector3PlusTest()
{
...
template <typename T>
inline HAMON_CXX14_CONSTEXPR bool Vector4PlusTest()
{
...
TYPED_TEST(VectorTest, PlusTest)
{
	using T = TypeParam;
	using vector2  = hamon::qvm::vector<T, 2>;
	using vector2i = hamon::qvm::vector<int, 2>;
	...
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector2 ( 1, 2) + vector2 (3, 4), vector2( 4, 6));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector2 (-3, 4) + vector2 (0, 2), vector2(-3, 6));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector2f(-3, 4) + vector2 (0, 2), vector2(-3, 6));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector2 (-3, 4) + vector2f(0, 2), vector2(-3, 6));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector2i(-3, 4) + vector2 (0, 2), vector2(-3, 6));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector2 (-3, 4) + vector2i(0, 2), vector2(-3, 6));

	// vector3 + vector3 -> vector3
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector3 ( 1, 2, 3) + vector3 (4, 5, 6), vector3( 5, 7, 9));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector3 (-3, 4, 5) + vector3 (0, 2,-1), vector3(-3, 6, 4));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector3f(-3, 4, 5) + vector3 (0, 2,-1), vector3(-3, 6, 4));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector3 (-3, 4, 5) + vector3f(0, 2,-1), vector3(-3, 6, 4));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector3i(-3, 4, 5) + vector3 (0, 2,-1), vector3(-3, 6, 4));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector3 (-3, 4, 5) + vector3i(0, 2,-1), vector3(-3, 6, 4));

	// vector4 + vector4 -> vector4
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector4 ( 1, 2, 3, 4) + vector4 (5, 6, 7, 8), vector4( 6, 8,10,12));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector4 (-3, 4, 5, 6) + vector4 (0, 2,-1, 3), vector4(-3, 6, 4, 9));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector4f(-3, 4, 5, 6) + vector4 (0, 2,-1, 3), vector4(-3, 6, 4, 9));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector4 (-3, 4, 5, 6) + vector4f(0, 2,-1, 3), vector4(-3, 6, 4, 9));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector4i(-3, 4, 5, 6) + vector4 (0, 2,-1, 3), vector4(-3, 6, 4, 9));
	HAMON_CXX11_CONSTEXPR_EXPECT_EQ(vector4 (-3, 4, 5, 6) + vector4i(0, 2,-1, 3), vector4(-3, 6, 4, 9));

	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(Vector2PlusTest<T>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(Vector3PlusTest<T>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(Vector4PlusTest<T>());
}
