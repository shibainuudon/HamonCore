...
TYPED_TEST(VectorTest, VectorCatTest)
{
	...
	}
	{
		...
		static_assert(hamon::is_same<decltype(v), const vector3>::value, "");
	...
	}
	{
		...
		static_assert(hamon::is_same<decltype(v), const vector4>::value, "");
	...
	}
	{
		...
		static_assert(hamon::is_same<decltype(v), const vector5>::value, "");
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(1, v[0]);
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(2, v[1]);
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(3, v[2]);
	...
	}
	{
		...
		static_assert(hamon::is_same<decltype(v), const vector6>::value, "");
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(1, v[0]);
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(2, v[1]);
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(3, v[2]);
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(4, v[3]);
