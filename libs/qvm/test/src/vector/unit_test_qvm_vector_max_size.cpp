/**
 *	@file	unit_test_qvm_vector_max_size.cpp
 *
 *	@brief	max_sizeのテスト
 */
...
TYPED_TEST(VectorTest, MaxSizeTest)
{
...

	{
		...
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(0u, v.max_size());
	}
	{
		HAMON_CONSTEXPR vector1 const v{};
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(1u, v.max_size());
	}
	{
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(2u, v.max_size());
	}
	{
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(3u, v.max_size());
	}
	{
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(4u, v.max_size());
	}
	{
