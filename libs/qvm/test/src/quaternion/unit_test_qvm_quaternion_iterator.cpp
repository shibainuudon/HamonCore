...
TYPED_TEST(QuaternionTest, IteratorTest)
{
	...
	static_assert(hamon::is_same<typename quaternion::iterator,       decltype(hamon::declval<quaternion>().begin())>::value, "");
	static_assert(hamon::is_same<typename quaternion::iterator,       decltype(hamon::declval<quaternion>().end())>::value, "");
	static_assert(hamon::is_same<typename quaternion::const_iterator, decltype(hamon::declval<quaternion>().cbegin())>::value, "");
	static_assert(hamon::is_same<typename quaternion::const_iterator, decltype(hamon::declval<quaternion>().cend())>::value, "");
	static_assert(hamon::is_same<typename quaternion::const_iterator, decltype(hamon::declval<quaternion const>().begin())>::value, "");
	static_assert(hamon::is_same<typename quaternion::const_iterator, decltype(hamon::declval<quaternion const>().end())>::value, "");
	static_assert(hamon::is_same<typename quaternion::const_iterator, decltype(hamon::declval<quaternion const>().cbegin())>::value, "");
	static_assert(hamon::is_same<typename quaternion::const_iterator, decltype(hamon::declval<quaternion const>().cend())>::value, "");
