...
inline HAMON_CXX14_CONSTEXPR bool AtTest()
{
...

	{
		...
		static_assert(std::is_same<decltype(q.at(0)), T&>::value, "");
		static_assert(std::is_same<decltype(q.at(1)), T&>::value, "");
		static_assert(std::is_same<decltype(q.at(2)), T&>::value, "");
		static_assert(std::is_same<decltype(q.at(3)), T&>::value, "");
		VERIFY(q.at(0) == 1);
		VERIFY(q.at(1) == 2);
		VERIFY(q.at(2) == 3);
		VERIFY(q.at(3) == 4);
...
TYPED_TEST(QuaternionTest, AtTest)
{
...

	{
		...
		static_assert(std::is_same<decltype(q.at(0)), T const&>::value, "");
		static_assert(std::is_same<decltype(q.at(1)), T const&>::value, "");
		static_assert(std::is_same<decltype(q.at(2)), T const&>::value, "");
		static_assert(std::is_same<decltype(q.at(3)), T const&>::value, "");
