...
inline HAMON_CXX14_CONSTEXPR bool Matrix3x3MulScalarTest()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3&>()  *= T{}),     matrix3x3&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3&>()  *= int{}),   matrix3x3&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3&>()  *= float{}), matrix3x3&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3i&>() *= T{}),     matrix3x3i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3i&>() *= int{}),   matrix3x3i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3i&>() *= float{}), matrix3x3i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3f&>() *= T{}),     matrix3x3f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3f&>() *= int{}),   matrix3x3f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x3f&>() *= float{}), matrix3x3f&>::value, "");
...
inline HAMON_CXX14_CONSTEXPR bool Matrix3x4MulScalarTest()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4&>()  *= T{}),     matrix3x4&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4&>()  *= int{}),   matrix3x4&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4&>()  *= float{}), matrix3x4&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4i&>() *= T{}),     matrix3x4i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4i&>() *= int{}),   matrix3x4i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4i&>() *= float{}), matrix3x4i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4f&>() *= T{}),     matrix3x4f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4f&>() *= int{}),   matrix3x4f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix3x4f&>() *= float{}), matrix3x4f&>::value, "");
...
inline HAMON_CXX14_CONSTEXPR bool Matrix4x3MulScalarTest()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3&>()  *= T{}),     matrix4x3&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3&>()  *= int{}),   matrix4x3&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3&>()  *= float{}), matrix4x3&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3i&>() *= T{}),     matrix4x3i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3i&>() *= int{}),   matrix4x3i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3i&>() *= float{}), matrix4x3i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3f&>() *= T{}),     matrix4x3f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3f&>() *= int{}),   matrix4x3f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x3f&>() *= float{}), matrix4x3f&>::value, "");
...
inline HAMON_CXX14_CONSTEXPR bool Matrix4x4MulScalarTest()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4&>()  *= T{}),     matrix4x4&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4&>()  *= int{}),   matrix4x4&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4&>()  *= float{}), matrix4x4&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4i&>() *= T{}),     matrix4x4i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4i&>() *= int{}),   matrix4x4i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4i&>() *= float{}), matrix4x4i&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4f&>() *= T{}),     matrix4x4f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4f&>() *= int{}),   matrix4x4f&>::value, "");
	static_assert(hamon::is_same<decltype(hamon::declval<matrix4x4f&>() *= float{}), matrix4x4f&>::value, "");
