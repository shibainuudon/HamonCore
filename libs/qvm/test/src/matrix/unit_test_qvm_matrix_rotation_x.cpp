/**
 *	@file	unit_test_qvm_matrix_rotation_x.cpp
 *
 *	@brief	rotation_x のテスト
 */
...
TYPED_TEST(MatrixFloatTest, RotationXTest)
{
	using T = TypeParam;
	using matrix3x3 = hamon::qvm::matrix<T, 3, 3>;

	static_assert(hamon::is_same<decltype(matrix3x3::rotation_x(0.0f)), matrix3x3>::value, "");
	static_assert(hamon::is_same<decltype(matrix3x3::rotation_x(0.0)),  matrix3x3>::value, "");
	static_assert(hamon::is_same<decltype(matrix3x3::rotation_x(0.0L)), matrix3x3>::value, "");

	{
		HAMON_CXX11_CONSTEXPR auto const m = matrix3x3::rotation_x(hamon::degrees_to_radians(0));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(matrix3x3::identity(), m);
	}
	{
		HAMON_CXX11_CONSTEXPR auto const m = matrix3x3::rotation_x(hamon::degrees_to_radians(30));
	...
	{
		HAMON_CXX11_CONSTEXPR auto const m = matrix3x3::rotation_x(hamon::degrees_to_radians(90));
		HAMON_CXX11_CONSTEXPR matrix3x3 const expected
		{
			1,  0, 0,
			0,  0, 1,
	...
	{
		HAMON_CXX11_CONSTEXPR auto const m1 = matrix3x3::rotation_x(hamon::degrees_to_radians(T(30)));
		HAMON_CXX11_CONSTEXPR auto const m2 = matrix3x3::rotation_x(hamon::units::degrees<T>{30});
		HAMON_CXX11_CONSTEXPR double error = 0.000000000000001;
	...
	{
		HAMON_CXX11_CONSTEXPR auto const m1 = matrix3x3::rotation_x(hamon::degrees_to_radians(T(45)));
		HAMON_CXX11_CONSTEXPR auto const m2 = matrix3x3::rotation_x(hamon::units::degrees<T>{45});
		HAMON_CXX11_CONSTEXPR double error = 0.000000000000001;
		HAMON_CXX11_CONSTEXPR_EXPECT_NEAR((double)m1[0][0], (double)m2[0][0], error);
		HAMON_CXX11_CONSTEXPR_EXPECT_NEAR((double)m1[0][1], (double)m2[0][1], error);
		HAMON_CXX11_CONSTEXPR_EXPECT_NEAR((double)m1[0][2], (double)m2[0][2], error);
	...
	{
		HAMON_CXX11_CONSTEXPR auto const m1 = matrix3x3::rotation_x(hamon::degrees_to_radians(T(60)));
		HAMON_CXX11_CONSTEXPR auto const m2 = matrix3x3::rotation_x(hamon::units::degrees<T>{60});
		HAMON_CXX11_CONSTEXPR double error = 0.000000000000001;
		HAMON_CXX11_CONSTEXPR_EXPECT_NEAR((double)m1[0][0], (double)m2[0][0], error);
		HAMON_CXX11_CONSTEXPR_EXPECT_NEAR((double)m1[0][1], (double)m2[0][1], error);
		HAMON_CXX11_CONSTEXPR_EXPECT_NEAR((double)m1[0][2], (double)m2[0][2], error);
