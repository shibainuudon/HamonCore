...
TYPED_TEST(MatrixFloatTest, RotationXTest)
{
	...
	static_assert(std::is_same<decltype(matrix3x3::rotation_x(0.0f)), matrix3x3>::value, "");
	static_assert(std::is_same<decltype(matrix3x3::rotation_x(0.0)),  matrix3x3>::value, "");
	static_assert(std::is_same<decltype(matrix3x3::rotation_x(0.0L)), matrix3x3>::value, "");
