/**
 *	@file	unit_test_qvm_matrix_look_at_rh.cpp
 *
 *	@brief	look_at_rh のテスト
 */
...
TYPED_TEST(MatrixFloatTest, LookAtRHTest)
{
	using T = TypeParam;
	...
	static_assert(std::is_same<
		decltype(matrix4x4::look_at_rh(vector3{}, vector3{}, vector3{})),
		matrix4x4
	>::value, "");

	{
		...
		HAMON_CONSTEXPR auto const m = matrix4x4::look_at_rh(eye, at, up);
