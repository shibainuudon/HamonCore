/**
 *	@file	unit_test_qvm_matrix_orthographic_rh.cpp
 *
 *	@brief	orthographic_rh のテスト
 */
...
TYPED_TEST(MatrixFloatTest, OrthographicRHTest)
{
	using T = TypeParam;
	using matrix4x4 = hamon::qvm::matrix<T, 4, 4>;

	static_assert(std::is_same<
		decltype(matrix4x4::orthographic_rh(T{}, T{}, T{}, T{}, T{}, T{})),
		matrix4x4
	>::value, "");

	{
		...
		HAMON_CONSTEXPR auto const m =
			matrix4x4::orthographic_rh(left, right, bottom, top, nearz, farz);
