/**
 *	@file	unit_test_qvm_matrix_frustum_lh.cpp
 *
 *	@brief	frustum_lh のテスト
 */
...
TYPED_TEST(MatrixFloatTest, FrustumLHTest)
{
	using T = TypeParam;
	using matrix4x4 = hamon::qvm::matrix<T, 4, 4>;

	static_assert(hamon::is_same<
		decltype(matrix4x4::frustum_lh(T{}, T{}, T{}, T{}, T{}, T{})),
		matrix4x4
	>::value, "");
	
	{
		...
		HAMON_CONSTEXPR auto const m =
			matrix4x4::frustum_lh(left, right, bottom, top, nearz, farz);
