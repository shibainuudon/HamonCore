...
inline HAMON_CXX14_CONSTEXPR bool Matrix3x3BracketTest()
{
...

	{
		...
		static_assert(std::is_same<decltype(m[0]), vector3&>::value, "");
		static_assert(std::is_same<decltype(m[1]), vector3&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector3&>::value, "");
...
inline HAMON_CXX14_CONSTEXPR bool Matrix3x4BracketTest()
{
...

	{
		...
		static_assert(std::is_same<decltype(m[0]), vector4&>::value, "");
		static_assert(std::is_same<decltype(m[1]), vector4&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector4&>::value, "");
...
inline HAMON_CXX14_CONSTEXPR bool Matrix4x3BracketTest()
{
...

	{
		...
		static_assert(std::is_same<decltype(m[1]), vector3&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector3&>::value, "");
		static_assert(std::is_same<decltype(m[3]), vector3&>::value, "");
		VERIFY(m[0] == vector3( 0,  1,  2));
		VERIFY(m[1] == vector3( 4,  5,  6));
		VERIFY(m[2] == vector3( 8,  9, 10));
...
inline HAMON_CXX14_CONSTEXPR bool Matrix4x4BracketTest()
{
...

	{
		...
		static_assert(std::is_same<decltype(m[1]), vector4&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector4&>::value, "");
		static_assert(std::is_same<decltype(m[3]), vector4&>::value, "");
		VERIFY(m[0] == vector4( 0,  1,  2,  3));
		VERIFY(m[1] == vector4( 4,  5,  6,  7));
		VERIFY(m[2] == vector4( 8,  9, 10, 11));
...
TYPED_TEST(MatrixTest, BracketTest)
{
...

	{
		...
		static_assert(std::is_same<decltype(m[0]), vector3 const&>::value, "");
		static_assert(std::is_same<decltype(m[1]), vector3 const&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector3 const&>::value, "");
	...
	}
	{
		...
		static_assert(std::is_same<decltype(m[0]), vector4 const&>::value, "");
		static_assert(std::is_same<decltype(m[1]), vector4 const&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector4 const&>::value, "");
	...
	}
	{
		...
		static_assert(std::is_same<decltype(m[1]), vector3 const&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector3 const&>::value, "");
		static_assert(std::is_same<decltype(m[3]), vector3 const&>::value, "");
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(m[0], vector3( 0,  1,  2));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(m[1], vector3( 4,  5,  6));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(m[2], vector3( 8,  9, 10));
	...
	}
	{
		...
		static_assert(std::is_same<decltype(m[1]), vector4 const&>::value, "");
		static_assert(std::is_same<decltype(m[2]), vector4 const&>::value, "");
		static_assert(std::is_same<decltype(m[3]), vector4 const&>::value, "");
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(m[0], vector4( 0,  1,  2,  3));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(m[1], vector4( 4,  5,  6,  7));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(m[2], vector4( 8,  9, 10, 11));
