/**
 *	@file	unit_test_qvm_matrix_look_to_rh.cpp
 *
 *	@brief	look_to_rh のテスト
 */
...
TYPED_TEST(MatrixFloatTest, LookToRHTest)
{
	using T = TypeParam;
	...
	static_assert(std::is_same<
		decltype(matrix4x4::look_to_rh(vector3{}, vector3{}, vector3{})),
		matrix4x4
	>::value, "");

	{
		...
		HAMON_CONSTEXPR auto const m = matrix4x4::look_to_rh(eye, direction, up);
