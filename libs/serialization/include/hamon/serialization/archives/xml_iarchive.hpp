...
#ifndef HAMON_SERIALIZATION_ARCHIVES_XML_IARCHIVE_HPP
#define HAMON_SERIALIZATION_ARCHIVES_XML_IARCHIVE_HPP
...
private:
	hamon::unique_ptr<detail::xml_iarchive_impl_base>	m_impl;
};
...
#endif // HAMON_SERIALIZATION_ARCHIVES_XML_IARCHIVE_HPP
