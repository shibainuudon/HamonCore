...
{
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test2<int, std::allocator>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test2<int, MyAllocator>()));
