...
{
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int, cpp17_input_iterator_wrapper>()));
//	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int, input_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int, forward_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int, bidirectional_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int, random_access_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<int, contiguous_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<char, cpp17_input_iterator_wrapper>()));
//	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<char, input_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<char, forward_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<char, bidirectional_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<char, random_access_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE((test1<char, contiguous_iterator_wrapper>()));
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE(test2<unsigned int>());
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE(test2<char>());
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE(test2<float>());
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE(test3<int>());
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE(test3<unsigned char>());
	/*HAMON_CXX20_CONSTEXPR_*/EXPECT_TRUE(test3<float>());
