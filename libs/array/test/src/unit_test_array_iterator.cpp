...
void IteratorTest()
{
	...
	static_assert( hamon::sized_sentinel_for<Iterator, ConstIterator>, "");
	static_assert(!hamon::sized_sentinel_for<Iterator, ReverseIterator>, "");
	static_assert(!hamon::sized_sentinel_for<Iterator, ConstReverseIterator>, "");
	...
	static_assert( hamon::sized_sentinel_for<ConstIterator, Iterator>, "");
	static_assert( hamon::sized_sentinel_for<ConstIterator, ConstIterator>, "");
	static_assert(!hamon::sized_sentinel_for<ConstIterator, ReverseIterator>, "");
	static_assert(!hamon::sized_sentinel_for<ConstIterator, ConstReverseIterator>, "");
