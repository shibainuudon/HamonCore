...
static_assert(!hamon::is_detected<invoke_shift_left, Bitflag1 const&, hamon::size_t>::value, "");
static_assert( hamon::is_detected<invoke_shift_left, Bitflag2 const&, int>::value, "");
static_assert( hamon::is_detected<invoke_shift_left, Bitflag2 const&, hamon::size_t>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left, Bitflag3 const&, int>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left, Bitflag3 const&, hamon::size_t>::value, "");
...
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag1&, hamon::size_t>::value, "");
static_assert( hamon::is_detected<invoke_shift_left_assign, Bitflag2&, int>::value, "");
static_assert( hamon::is_detected<invoke_shift_left_assign, Bitflag2&, hamon::size_t>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag3&, int>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag3&, hamon::size_t>::value, "");

static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag1 const&, int>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag1 const&, hamon::size_t>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag2 const&, int>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag2 const&, hamon::size_t>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag3 const&, int>::value, "");
static_assert(!hamon::is_detected<invoke_shift_left_assign, Bitflag3 const&, hamon::size_t>::value, "");
