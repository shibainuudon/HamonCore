...
using invoke_set = decltype(hamon::declval<T>().set(hamon::declval<U>()...));
...
HAMON_WARNING_DISABLE_GCC("-Wconversion")
	...
	{
		Bitflag1 b{};
		EXPECT_THROW   ((void)b.set((Enum1)-1), hamon::out_of_range);
		EXPECT_NO_THROW((void)b.set((Enum1)0));
		EXPECT_NO_THROW((void)b.set((Enum1)31));
		EXPECT_THROW   ((void)b.set((Enum1)32), hamon::out_of_range);
	}
	{
		Bitflag2 b{};
		EXPECT_THROW   ((void)b.set((Enum2)-1), hamon::out_of_range);
		EXPECT_NO_THROW((void)b.set((Enum2)0));
		EXPECT_NO_THROW((void)b.set((Enum2)4));
		EXPECT_THROW   ((void)b.set((Enum2)5), hamon::out_of_range);
	}
	{
		Bitflag3 b{};
		EXPECT_THROW   ((void)b.set((Enum3)-1), hamon::out_of_range);
		EXPECT_NO_THROW((void)b.set((Enum3)0));
		EXPECT_NO_THROW((void)b.set((Enum3)15));
		EXPECT_THROW   ((void)b.set((Enum3)16), hamon::out_of_range);
	}
#endif
