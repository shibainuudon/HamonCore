...
HAMON_WARNING_DISABLE_GCC("-Wconversion")

	{
		...
		EXPECT_THROW   ((void)b.test((Enum1)32), std::out_of_range);
	}
	{
		Bitflag2 b{};
		EXPECT_THROW   ((void)b.test((Enum2)-1), std::out_of_range);
		EXPECT_NO_THROW((void)b.test((Enum2)0));
		EXPECT_NO_THROW((void)b.test((Enum2)4));
		EXPECT_THROW   ((void)b.test((Enum2)5), std::out_of_range);
	}
	{
		Bitflag3 b{};
		EXPECT_THROW   ((void)b.test((Enum3)-1), std::out_of_range);
