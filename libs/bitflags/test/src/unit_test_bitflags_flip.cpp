...
HAMON_WARNING_DISABLE_GCC("-Wconversion")
	...
	{
		Bitflag1 b{};
		EXPECT_THROW   ((void)b.flip((Enum1)-1), hamon::out_of_range);
		EXPECT_NO_THROW((void)b.flip((Enum1)0));
		EXPECT_NO_THROW((void)b.flip((Enum1)31));
		EXPECT_THROW   ((void)b.flip((Enum1)32), hamon::out_of_range);
	}
	{
		Bitflag2 b{};
		EXPECT_THROW   ((void)b.flip((Enum2)-1), hamon::out_of_range);
		EXPECT_NO_THROW((void)b.flip((Enum2)0));
		EXPECT_NO_THROW((void)b.flip((Enum2)4));
		EXPECT_THROW   ((void)b.flip((Enum2)5), hamon::out_of_range);
	}
	{
		Bitflag3 b{};
		EXPECT_THROW   ((void)b.flip((Enum3)-1), hamon::out_of_range);
		EXPECT_NO_THROW((void)b.flip((Enum3)0));
		EXPECT_NO_THROW((void)b.flip((Enum3)15));
		EXPECT_THROW   ((void)b.flip((Enum3)16), hamon::out_of_range);
	}
#endif
