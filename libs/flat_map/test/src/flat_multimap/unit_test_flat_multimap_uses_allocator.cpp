/**
 *	@file	unit_test_flat_multimap_uses_allocator.cpp
 *
...
GTEST_TEST(FlatMultimapTest, UsesAllocatorTest)
{
	using Map1 = hamon::flat_multimap<int, float, hamon::less<int>, UseAllocContainer<int>, UseAllocContainer<float>>;
	using Map2 = hamon::flat_multimap<int, float, hamon::less<int>, UseAllocContainer<int>, MinSequenceContainer<float>>;
