...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	static_assert( hamon::is_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>>::value, "");
	static_assert( hamon::is_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>, Compare const&>::value, "");
	...
	static_assert(!hamon::is_nothrow_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>>::value, "");
	static_assert(!hamon::is_nothrow_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>, Compare const&>::value, "");
	...
	static_assert( hamon::is_implicitly_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>>::value, "");
	static_assert( hamon::is_implicitly_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>, Compare const&>::value, "");
	...
	static_assert(!hamon::is_trivially_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>>::value, "");
	static_assert(!hamon::is_trivially_constructible<Map, hamon::sorted_equivalent_t, hamon::initializer_list<ValueType>, Compare const&>::value, "");
