...
FLAT_MAP_TEST_CONSTEXPR bool test()
{
	...
	static_assert( hamon::is_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Alloc const&>::value, "");
	static_assert( hamon::is_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Compare const&, Alloc const&>::value, "");
	...
	static_assert(!hamon::is_nothrow_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Alloc const&>::value, "");
	static_assert(!hamon::is_nothrow_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Compare const&, Alloc const&>::value, "");
	...
	static_assert( hamon::is_implicitly_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Alloc const&>::value, "");
	static_assert( hamon::is_implicitly_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Compare const&, Alloc const&>::value, "");
	...
	static_assert(!hamon::is_trivially_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Alloc const&>::value, "");
	static_assert(!hamon::is_trivially_constructible<Map, hamon::sorted_equivalent_t, std::initializer_list<ValueType>, Compare const&, Alloc const&>::value, "");
