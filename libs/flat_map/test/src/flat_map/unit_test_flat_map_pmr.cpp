...
GTEST_TEST(FlatMapTest, PmrTest)
{
	...
	}
	{
		...
		using M = hamon::flat_map<hamon::pmr::string, int, hamon::less<>, hamon::pmr::vector<hamon::pmr::string>, hamon::pmr::vector<int>>;
		hamon::pmr::monotonic_buffer_resource mr1;
		hamon::pmr::monotonic_buffer_resource mr2;
		M mo = M({{"short", 1},
	...
	{
		// flat_map(sorted_unique_t, const key_container_type& key_cont, const mapped_container_type& mapped_cont, const Alloc& a);
		using M = hamon::flat_map<int, int, hamon::less<int>, hamon::pmr::vector<int>, hamon::pmr::vector<int>>;
		hamon::pmr::monotonic_buffer_resource mr;
		hamon::pmr::vector<M> vm(&mr);
