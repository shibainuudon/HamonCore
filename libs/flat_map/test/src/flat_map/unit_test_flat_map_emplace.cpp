...
HAMON_CXX20_CONSTEXPR bool test2()
{
	...
	static_assert( is_emplace_invocable<Map&, hamon::piecewise_construct_t, hamon::tuple<int>, hamon::tuple<int, int>>::value, "");
	...
	static_assert(!is_emplace_invocable<Map const&, hamon::piecewise_construct_t, hamon::tuple<int>, hamon::tuple<int, int>>::value, "");
