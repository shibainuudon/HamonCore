/**
 *	@file	unit_test_flat_map_ctor_cont_alloc.cpp
 *
...
FLAT_MAP_TEST_CONSTEXPR bool test()
{
	...
	static_assert( hamon::is_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Alloc const&>::value, "");
	static_assert( hamon::is_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Compare const&, Alloc const&>::value, "");
	...
	static_assert(!hamon::is_nothrow_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Alloc const&>::value, "");
	static_assert(!hamon::is_nothrow_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Compare const&, Alloc const&>::value, "");
	...
	static_assert( hamon::is_implicitly_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Alloc const&>::value, "");
	static_assert( hamon::is_implicitly_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Compare const&, Alloc const&>::value, "");
	...
	static_assert(!hamon::is_trivially_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Alloc const&>::value, "");
	static_assert(!hamon::is_trivially_constructible<Map, hamon::sorted_unique_t, KeyContainer, MappedContainer, Compare const&, Alloc const&>::value, "");
	...
	}
	{
		...
		Alloc const alloc;
		hamon::flat_map<Key, T, TestLess<Key>, KeyContainer, MappedContainer> v{key_cont, mapped_cont, comp, alloc};
		VERIFY(check_invariant(v));
		VERIFY(v.size() == 4);
	...
	}
	{
		...
		Alloc const alloc;
		Map v{hamon::sorted_unique, key_cont, mapped_cont, alloc};
		VERIFY(check_invariant(v));
		VERIFY(!v.empty());
		VERIFY(v.size() == 3);
	...
	}
	{
		...
		Alloc const alloc;
		hamon::flat_map<Key, T, TestLess<Key>, KeyContainer, MappedContainer> v{hamon::sorted_unique, key_cont, mapped_cont, comp, alloc};
		VERIFY(check_invariant(v));
		VERIFY(v.size() == 4);
		VERIFY(v.key_comp() == comp);
		auto it = v.begin();
...
GTEST_TEST(FlatMapTest, CtorContAllocTest)
{
