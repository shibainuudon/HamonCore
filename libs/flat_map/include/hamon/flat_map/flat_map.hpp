...
public:
	...
	>
	constexpr
	flat_map(hamon::from_range_t, R&& rg, Alloc const& a);
	...
	>
	constexpr
	flat_map(hamon::from_range_t, R&& rg, key_compare const& comp, Alloc const& a);
	...
	template <class Alloc>
	constexpr
	flat_map(std::initializer_list<value_type> il, key_compare const& comp, Alloc const& a);

	template <class Alloc>
	constexpr
	flat_map(sorted_unique_t, std::initializer_list<value_type> il, Alloc const& a);

	template <class Alloc>
	constexpr
	flat_map(sorted_unique_t, std::initializer_list<value_type> il, key_compare const& comp, Alloc const& a);
	...
	template <HAMON_CONSTRAINED_PARAM(hamon::detail::cpp17_input_iterator, InputIterator)>
	constexpr void
	insert(sorted_unique_t, InputIterator first, InputIterator last);
	...
	constexpr void
	insert(sorted_unique_t, std::initializer_list<value_type> il)
	{
...
>
flat_map(hamon::from_range_t, R&&, Compare = Compare(), Allocator = Allocator())
->flat_map<
...
>
flat_map(std::initializer_list<hamon::pair<Key, T>>, Compare = Compare())
->flat_map<
	Key,
	T,
	Compare>;
...
template <
	...
	class Compare = hamon::less<Key>
>
flat_map(sorted_unique_t, std::initializer_list<hamon::pair<Key, T>>, Compare = Compare())
->flat_map<
	Key,
	T,
	Compare>;
...
public:
	...
	template <HAMON_CONSTRAINED_PARAM(hamon::detail::cpp17_input_iterator, InputIterator)>
	constexpr void
	insert(sorted_equivalent_t, InputIterator first, InputIterator last);
	...
	constexpr void
	insert(sorted_equivalent_t, std::initializer_list<value_type> il)
	{
...
template <
	...
	class Allocator = hamon::allocator<byte>
>
flat_multimap(hamon::from_range_t, R&&, Compare = Compare(), Allocator = Allocator())
->flat_multimap<
	hamon::detail::range_key_type<R>,
	hamon::detail::range_mapped_type<R>,
	Compare,
...
template <
	...
	class Compare = hamon::less<Key>
>
flat_multimap(std::initializer_list<hamon::pair<Key, T>>, Compare = Compare())
->flat_multimap<
	Key,
	T,
	Compare>;
...
template <
	...
	class Compare = hamon::less<Key>
>
flat_multimap(sorted_equivalent_t, std::initializer_list<hamon::pair<Key, T>>, Compare = Compare())
->flat_multimap<
	Key,
	T,
	Compare>;
