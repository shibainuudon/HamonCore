...
#ifndef UNIT_TEST_TEST_COMMON_CONSTEXPR_TEST_HPP
#define UNIT_TEST_TEST_COMMON_CONSTEXPR_TEST_HPP
...
#  define HAMON_CXX20_CONSTEXPR_EXPECT_EQ(x, y)	\
	static_assert((x) == (y), "");	\
	EXPECT_EQ(x, y)

#  define HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(x)	\
	static_assert((x), #x);	\
	EXPECT_TRUE(x)

#  define HAMON_CXX20_CONSTEXPR_EXPECT_FALSE(x)	\
	static_assert(!(x), #x);	\
	EXPECT_FALSE(x)
...
#endif // UNIT_TEST_TEST_COMMON_CONSTEXPR_TEST_HPP
