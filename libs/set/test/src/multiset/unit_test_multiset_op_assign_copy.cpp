...
MULTISET_TEST_CONSTEXPR bool test1()
{
	...
	static_assert( hamon::is_copy_assignable<Set>::value, "");
	static_assert(!hamon::is_nothrow_copy_assignable<Set>::value, "");
	static_assert(!hamon::is_trivially_copy_assignable<Set>::value, "");

	Set v1;
	VERIFY(v1.empty());

	{
		Set const v2 {Key{3}, Key{1}, Key{4}};
		auto& r = (v1 = v2);
		VERIFY(&r == &v1);
		VERIFY(&r != &v2);
		VERIFY(v1.size() == 3);
...
HAMON_WARNING_POP()
	{
		Set const v2 {Key{1}, Key{2}, Key{3}, Key{4}, Key{5}};
		auto& r = (v1 = v2);
		VERIFY(&r == &v1);
		VERIFY(&r != &v2);
		VERIFY(v1.size() == 5);
...
MULTISET_TEST_CONSTEXPR bool test2()
{
	...
	{
		Set const v2 {{Key{3}, Key{1}, Key{4}}, Allocator{20}};
		v1 = v2;
...
MULTISET_TEST_CONSTEXPR bool test4()
{
	...
	{
		Set const v2 {{Key{3}, Key{1}, Key{4}}, Compare{20}};
		v1 = v2;
