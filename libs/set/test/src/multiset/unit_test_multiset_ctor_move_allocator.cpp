...
GTEST_TEST(MultisetTest, CtorMoveAllocatorTest)
{
	...
	S::s_dtor_count = 0;
	{
		...
		hamon::multiset<S, hamon::less<>, MyAllocator1<S>> v2{hamon::move(v1), MyAllocator1<S>{10}};
		EXPECT_EQ(4, S::s_ctor_count);
		EXPECT_EQ(0, S::s_copy_ctor_count);
		EXPECT_EQ(0, S::s_move_ctor_count);
		EXPECT_EQ(0, S::s_dtor_count);
	...
	S::s_dtor_count = 0;
	{
		...
		hamon::multiset<S, hamon::less<>, MyAllocator1<S>> v2{hamon::move(v1), MyAllocator1<S>{20}};
		EXPECT_EQ(4, S::s_ctor_count);
		EXPECT_EQ(0, S::s_copy_ctor_count);
