...
GTEST_TEST(SetTest, SwapTest)
{
	...
	{
		hamon::set<int> a1 {3, 1, 3, 2}, a2 {5, 4, 5};
		...
		EXPECT_EQ("{1, 2, 3}", ToString(a1));
		EXPECT_EQ("{4, 5}", ToString(a2));
		EXPECT_EQ(2, *it1);
		EXPECT_EQ(5, *it2);
		EXPECT_EQ(1, ref1);
		EXPECT_EQ(4, ref2);
		...
		EXPECT_EQ("{4, 5}", ToString(a1));
		EXPECT_EQ("{1, 2, 3}", ToString(a2));
		EXPECT_EQ(2, *it1);
		EXPECT_EQ(5, *it2);
		EXPECT_EQ(1, ref1);
		EXPECT_EQ(4, ref2);
		...
		hamon::set<int, Cmp> s1{{2, 2, 1, 1}, Cmp{6}}, s2{{4, 4, 3, 3}, Cmp{9}};

		EXPECT_EQ("{1, 2}", ToString(s1));
		EXPECT_EQ("{3, 4}", ToString(s2));
		EXPECT_EQ(6, s1.key_comp().id);
		EXPECT_EQ(9, s2.key_comp().id);

		s1.swap(s2);

		EXPECT_EQ("{3, 4}", ToString(s1));
		EXPECT_EQ("{1, 2}", ToString(s2));
