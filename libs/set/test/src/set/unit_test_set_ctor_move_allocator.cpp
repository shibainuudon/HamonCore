/**
 *	@file	unit_test_set_ctor_move_allocator.cpp
 *
...
GTEST_TEST(SetTest, CtorMoveAllocatorTest)
{
	...
	S::s_dtor_count = 0;
	{
		...
		hamon::set<S, hamon::less<>, MyAllocator1<S>> v2{hamon::move(v1), MyAllocator1<S>{10}};
		EXPECT_EQ(4, S::s_ctor_count);
		EXPECT_EQ(0, S::s_copy_ctor_count);
		EXPECT_EQ(0, S::s_move_ctor_count);
		EXPECT_EQ(1, S::s_dtor_count);
	...
	S::s_dtor_count = 0;
	{
		...
		hamon::set<S, hamon::less<>, MyAllocator1<S>> v2{hamon::move(v1), MyAllocator1<S>{20}};
		EXPECT_EQ(4, S::s_ctor_count);
		EXPECT_EQ(0, S::s_copy_ctor_count);
