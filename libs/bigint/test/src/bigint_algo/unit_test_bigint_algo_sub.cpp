...
test(VectorType a, VectorType const& b, VectorType const& expected)
{
...
GTEST_TEST(BigIntAlgoTest, SubTest)
{
#if 0
	{
		...
		hamon::vector<hamon::uint8_t> b{0xFF, 0x01};
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint8_t>{0x39, 0x30},	// 12345
		hamon::vector<hamon::uint8_t>{0x03},
		hamon::vector<hamon::uint8_t>{0x36, 0x30}));	// 12342
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint8_t>{0x00, 0x00, 0x01},
		hamon::vector<hamon::uint8_t>{0x01},
		hamon::vector<hamon::uint8_t>{0xFF, 0xFF}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint8_t>{0x56, 0x34, 0x12},
		hamon::vector<hamon::uint8_t>{0x89, 0x30, 0x12},
		hamon::vector<hamon::uint8_t>{0xCD, 0x03}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint8_t>{0x78, 0x56, 0x34, 0x12},
		hamon::vector<hamon::uint8_t>{0x78, 0x56, 0x34, 0x12},
		hamon::vector<hamon::uint8_t>{0x00}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint8_t>{0x15, 0x81, 0xE9, 0x7D, 0xF4, 0x10, 0x22, 0x11, 0x1E, 0x78, 0xBE, 0x41, 0x1D, 0x42, 0x70, 0x50},
		hamon::vector<hamon::uint8_t>{0xD0, 0x08, 0x51, 0xF2, 0x96, 0xFA, 0x5D, 0x0D, 0x81, 0x42, 0x21, 0x00, 0x28, 0x88, 0x24, 0x33},
		hamon::vector<hamon::uint8_t>{0x45, 0x78, 0x98, 0x8B, 0x5D, 0x16, 0xC4, 0x03, 0x9D, 0x35, 0x9D, 0x41, 0xF5, 0xB9, 0x4B, 0x1D}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint16_t>{0x0000, 0x0000, 0x0000, 0x0001},
		hamon::vector<hamon::uint16_t>{0x0002},
		hamon::vector<hamon::uint16_t>{0xFFFE, 0xFFFF, 0xFFFF}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint16_t>{0xB0A1, 0x12B9},
		hamon::vector<hamon::uint16_t>{0x614E, 0x00BC},
		hamon::vector<hamon::uint16_t>{0x4F53, 0x11FD}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint16_t>{0x8115, 0x7DE9, 0x10F4, 0x1122, 0x781E, 0x41BE, 0x421D, 0x5070},
		hamon::vector<hamon::uint16_t>{0x08D0, 0xF251, 0xFA96, 0x0D5D, 0x4281, 0x0021, 0x8828, 0x3324},
		hamon::vector<hamon::uint16_t>{0x7845, 0x8B98, 0x165D, 0x03C4, 0x359D, 0x419D, 0xB9F5, 0x1D4B}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint32_t>{0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000010},
		hamon::vector<hamon::uint32_t>{0x00000000, 0x00000001},
		hamon::vector<hamon::uint32_t>{0x00000000, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x0000000F}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint32_t>{0x7DE98115, 0x112210F4, 0x41BE781E, 0x5070421D},
		hamon::vector<hamon::uint32_t>{0xF25108D0, 0x0D5DFA96, 0x00214281, 0x33248828},
		hamon::vector<hamon::uint32_t>{0x8B987845, 0x03C4165D, 0x419D359D, 0x1D4BB9F5}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		hamon::inplace_vector<hamon::uint8_t, 4>{0x56, 0x34, 0x12},
		hamon::inplace_vector<hamon::uint8_t, 4>{0x89, 0x30, 0x12},
		hamon::inplace_vector<hamon::uint8_t, 4>{0xCD, 0x03}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
