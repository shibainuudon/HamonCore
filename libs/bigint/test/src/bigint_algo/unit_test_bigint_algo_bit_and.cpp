...
GTEST_TEST(BigIntAlgoTest, BitAndTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		...
		hamon::inplace_vector<hamon::uint64_t, 2>{0x012300008900CD00, 0x1122334400000000}));
