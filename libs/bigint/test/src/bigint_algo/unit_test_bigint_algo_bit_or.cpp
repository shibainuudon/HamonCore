...
GTEST_TEST(BigIntAlgoTest, BitOrTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		...
		hamon::vector<hamon::uint8_t>{0xFF, 0xFF, 0xFF, 0x78}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint8_t>{0x12, 0x34, 0x56, 0x78},
		hamon::vector<hamon::uint8_t>{0xFF, 0x0F, 0xF0},
		hamon::vector<hamon::uint8_t>{0xFF, 0x3F, 0xF6, 0x78}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		hamon::vector<hamon::uint16_t>{0x4996, 0x02D2},
		hamon::vector<hamon::uint16_t>{0x12B9, 0xB0A1},
		hamon::vector<hamon::uint16_t>{0x5BBF, 0xB2F3}));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
		...
		hamon::vector<hamon::uint64_t>{0xFFFF4567FFABFFEF, 0xFFFFFFFF55667788}));
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		...
		hamon::inplace_vector<hamon::uint8_t, 4>{0xFF, 0xFF, 0xFF},
		hamon::inplace_vector<hamon::uint8_t, 4>{0xFF, 0xFF, 0xFF, 0x78}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		hamon::inplace_vector<hamon::uint8_t, 4>{0x12, 0x34, 0x56, 0x78},
		hamon::inplace_vector<hamon::uint8_t, 4>{0xFF, 0x0F, 0xF0},
		hamon::inplace_vector<hamon::uint8_t, 4>{0xFF, 0x3F, 0xF6, 0x78}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		hamon::inplace_vector<hamon::uint16_t, 2>{0x4996, 0x02D2},
		hamon::inplace_vector<hamon::uint16_t, 2>{0x12B9, 0xB0A1},
		hamon::inplace_vector<hamon::uint16_t, 2>{0x5BBF, 0xB2F3}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		hamon::inplace_vector<hamon::uint16_t, 4>{0x4996, 0x02D2, 0xFFFF, 0x1234},
		hamon::inplace_vector<hamon::uint16_t, 4>{0x0000},
		hamon::inplace_vector<hamon::uint16_t, 4>{0x4996, 0x02D2, 0xFFFF, 0x1234}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		...
		hamon::inplace_vector<hamon::uint64_t, 2>{0xFFFF4567FFABFFEF, 0xFFFFFFFF55667788}));
...

	{
		...
		HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
			...
			Vector1{0xFF, 0xFF, 0xFF, 0x78}));
		HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
			Vector1{0xFF, 0x0F, 0xF0},
			Vector2{0x12, 0x34, 0x56, 0x78},
			Vector1{0xFF, 0x3F, 0xF6, 0x78}));
	}
	{
		...
		HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
			Vector1{0x0000},
			Vector2{0x4996, 0x02D2, 0xFFFF, 0x1234},
			Vector1{0x4996, 0x02D2, 0xFFFF, 0x1234}));
	}
	{
		...
		HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
			Vector1{0x12345678, 0x12345678, 0x12345678},
			Vector2{0xFFFF0000, 0xFF00FF00},
			Vector1{0xFFFF5678, 0xFF34FF78, 0x12345678}));
		HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(test(
			Vector1{0xFFFF0000, 0xFF00FF00},
			Vector2{0x12345678, 0x12345678, 0x12345678},
			Vector1{0xFFFF5678, 0xFF34FF78, 0x12345678}));
	}
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		...
		MyVector<hamon::uint8_t, 4>{0xFF, 0xFF, 0xFF},
		MyVector<hamon::uint8_t, 4>{0xFF, 0xFF, 0xFF, 0x78}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		MyVector<hamon::uint8_t, 4>{0x12, 0x34, 0x56, 0x78},
		MyVector<hamon::uint8_t, 4>{0xFF, 0x0F, 0xF0},
		MyVector<hamon::uint8_t, 4>{0xFF, 0x3F, 0xF6, 0x78}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		MyVector<hamon::uint16_t, 2>{0x4996, 0x02D2},
		MyVector<hamon::uint16_t, 2>{0x12B9, 0xB0A1},
		MyVector<hamon::uint16_t, 2>{0x5BBF, 0xB2F3}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		MyVector<hamon::uint16_t, 4>{0x4996, 0x02D2, 0xFFFF, 0x1234},
		MyVector<hamon::uint16_t, 4>{0x0000},
		MyVector<hamon::uint16_t, 4>{0x4996, 0x02D2, 0xFFFF, 0x1234}));
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(test(
		...
		MyVector<hamon::uint64_t, 2>{0xFFFF4567FFABFFEF, 0xFFFFFFFF55667788}));
}
