...
{
	{
		...
		auto const c1 = hamon::bigint_algo::bit_xor(a, b);
		auto const c2 = hamon::bigint_algo::bit_xor(b, a);
...

	{
		...
		HAMON_CXX11_CONSTEXPR auto const c = hamon::bigint_algo::bit_xor(a, b);
