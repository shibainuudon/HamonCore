...
{
	{
		...
		EXPECT_EQ( 0, hamon::detail::bigint_algo::compare(a, b));
		EXPECT_EQ( 0, hamon::detail::bigint_algo::compare(b, a));
	}
	{
		std::vector<hamon::uint8_t> const a{0};
		std::vector<hamon::uint8_t> const b{1};
		EXPECT_EQ(-1, hamon::detail::bigint_algo::compare(a, b));
		EXPECT_EQ( 1, hamon::detail::bigint_algo::compare(b, a));
	}
	{
...

	{
		...
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ( 0, hamon::detail::bigint_algo::compare(a, b));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ( 0, hamon::detail::bigint_algo::compare(b, a));
	}
	{
		...
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ(-1, hamon::detail::bigint_algo::compare(a, b));
		HAMON_CXX11_CONSTEXPR_EXPECT_EQ( 1, hamon::detail::bigint_algo::compare(b, a));
	}
	{
		HAMON_CXX11_CONSTEXPR hamon::array<hamon::uint8_t, 4> const a{0x12, 0x34, 0x56, 0x78};
