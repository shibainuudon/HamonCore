...
{
	{
		...
		auto const c = hamon::detail::bigint_algo::div_mod(a, b);
	...
	}
	{
		...
		auto c = hamon::detail::bigint_algo::div_mod(a, b);
...

	{
		...
		HAMON_CXX14_CONSTEXPR auto c = hamon::detail::bigint_algo::div_mod(a, b);
