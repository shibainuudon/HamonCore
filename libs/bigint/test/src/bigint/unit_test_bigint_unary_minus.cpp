...
{
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest<hamon::bigint>());

	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest<hamon::inplace_bigint<512>>());
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest2<hamon::bigint>());

	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnaryMinusTest2<hamon::inplace_bigint<512>>());
