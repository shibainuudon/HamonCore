...
GTEST_TEST(BigIntTest, ToCharsTest)
{
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(ToCharsSignedTest<hamon::int256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(ToCharsSignedTest<hamon::int512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(ToCharsUnsignedTest<hamon::uint256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(ToCharsUnsignedTest<hamon::uint512_t>());
