...
GTEST_TEST(BigIntTest, MulTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest<hamon::int1024_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest<hamon::uint1024_t>());
...
//	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest2<hamon::int128_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest2<hamon::int1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest2<hamon::int2048_t>());
...
//	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest2<hamon::uint128_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest2<hamon::uint1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(MulTest2<hamon::uint2048_t>());
}
