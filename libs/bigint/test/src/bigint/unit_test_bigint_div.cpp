...
GTEST_TEST(BigIntTest, DivTest)
{
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedDivTest<hamon::int512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedDivTest<hamon::uint512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(SignedDivTest<hamon::int512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*///EXPECT_TRUE(UnsignedDivTest2<hamon::int128_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedDivTest2<hamon::int256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedDivTest2<hamon::int512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*///EXPECT_TRUE(UnsignedDivTest2<hamon::uint128_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedDivTest2<hamon::uint256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedDivTest2<hamon::uint512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*///EXPECT_TRUE(SignedDivTest2<hamon::int128_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(SignedDivTest2<hamon::int256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(SignedDivTest2<hamon::int512_t>());
