...
GTEST_TEST(BigIntTest, CtorStringTest)
{
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(CtorStringTest<hamon::int256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(CtorStringTest<hamon::int512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(CtorStringTest<hamon::uint256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(CtorStringTest<hamon::uint512_t>());
