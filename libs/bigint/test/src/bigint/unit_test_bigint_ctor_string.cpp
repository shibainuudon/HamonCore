...
GTEST_TEST(BigIntTest, CtorStringTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(CtorStringTest<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(CtorStringTest<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(CtorStringTest<hamon::inplace_bigint<512>>());
