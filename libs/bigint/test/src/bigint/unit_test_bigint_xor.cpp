...
GTEST_TEST(BigIntTest, XorTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(XorTest<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(XorTest<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(XorTest<hamon::inplace_bigint<512>>());
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(XorTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(XorTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(XorTest2<hamon::inplace_bigint<512>>());
