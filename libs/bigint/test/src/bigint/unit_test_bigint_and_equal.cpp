...
GTEST_TEST(BigIntTest, AndEqualTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AndEqualTest<hamon::int1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AndEqualTest<hamon::int2048_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AndEqualTest<hamon::uint1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AndEqualTest<hamon::uint2048_t>());

	EXPECT_TRUE(AndEqualTest2<hamon::bigint>());

	EXPECT_TRUE(AndEqualTest2<hamon::int128_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::int256_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::int512_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::int1024_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::int2048_t>());

	EXPECT_TRUE(AndEqualTest2<hamon::uint128_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::uint256_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::uint512_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::uint1024_t>());
	EXPECT_TRUE(AndEqualTest2<hamon::uint2048_t>());
}
