...
GTEST_TEST(BigIntTest, CtorIntegralTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(CtorIntegralTest<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(CtorIntegralTest<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(CtorIntegralTest<hamon::inplace_bigint<512>>());
