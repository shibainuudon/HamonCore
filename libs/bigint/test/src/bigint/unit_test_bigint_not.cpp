...
{
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(NotTest<hamon::bigint>());

	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(NotTest<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(NotTest<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(NotTest<hamon::inplace_bigint<512>>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(NotTest<hamon::int1024_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(NotTest<hamon::int2048_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(NotTest<hamon::uint1024_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(NotTest<hamon::uint2048_t>());

	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(NotTest2<hamon::bigint>());

	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(NotTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(NotTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(NotTest2<hamon::inplace_bigint<512>>());
