...
GTEST_TEST(BigIntTest, MulEqualTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(MulEqualTest<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(MulEqualTest<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(MulEqualTest<hamon::inplace_bigint<512>>());
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(MulEqualTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(MulEqualTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(MulEqualTest2<hamon::inplace_bigint<512>>());
