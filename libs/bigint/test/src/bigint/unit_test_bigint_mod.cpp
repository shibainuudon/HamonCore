...
GTEST_TEST(BigIntTest, ModTest)
{
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedModTest<hamon::int512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedModTest<hamon::uint512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(SignedModTest<hamon::int512_t>());
...
//	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnsignedModTest2<hamon::int128_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedModTest2<hamon::int512_t>());
...
//	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(UnsignedModTest2<hamon::uint128_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(UnsignedModTest2<hamon::uint512_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(SignedModTest2<hamon::int256_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(SignedModTest2<hamon::int512_t>());
