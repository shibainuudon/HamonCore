...
GTEST_TEST(BigIntTest, SubEqualTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubEqualTest<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubEqualTest<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubEqualTest<hamon::inplace_bigint<512>>());
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubEqualTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubEqualTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubEqualTest2<hamon::inplace_bigint<512>>());
