...
GTEST_TEST(BigIntTest, ShiftRightTest)
{
	...
	EXPECT_TRUE(ShiftRightTest2<hamon::int128_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::int256_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::int512_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::int1024_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::int2048_t>());

	EXPECT_TRUE(ShiftRightTest2<hamon::uint128_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::uint256_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::uint512_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::uint1024_t>());
	EXPECT_TRUE(ShiftRightTest2<hamon::uint2048_t>());
}
