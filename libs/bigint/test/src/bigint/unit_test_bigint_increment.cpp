...
GTEST_TEST(BigIntTest, IncrementTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(IncrementTest2<hamon::int1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(IncrementTest2<hamon::int2048_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(IncrementTest2<hamon::uint1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(IncrementTest2<hamon::uint2048_t>());
}
