...
GTEST_TEST(BigIntTest, AddEqualTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AddEqualTest<hamon::inplace_bigint<128>>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::inplace_bigint<512>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::inplace_bigint<2048>>());
