...
GTEST_TEST(BigIntTest, AddEqualTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest<hamon::inplace_bigint<512>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest<hamon::inplace_bigint<2048>>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(AddEqualTest<hamon::uint1024_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(AddEqualTest<hamon::uint2048_t>());

	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::bigint>());

	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::inplace_bigint<512>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(AddEqualTest2<hamon::inplace_bigint<2048>>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(AddEqualTest2<hamon::int1024_t>());
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(AddEqualTest2<hamon::int2048_t>());
	...
	/*HAMON_CXX14_CONSTEXPR_*/EXPECT_TRUE(AddEqualTest2<hamon::uint1024_t>());
