...
GTEST_TEST(BigIntTest, ShiftLeftEqualTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::inplace_bigint<512>>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest2<hamon::inplace_bigint<512>>());
