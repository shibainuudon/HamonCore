...
GTEST_TEST(BigIntTest, ShiftLeftEqualTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::int1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::int2048_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::uint1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(ShiftLeftEqualTest<hamon::uint2048_t>());

	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::bigint>());

	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::int128_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::int256_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::int512_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::int1024_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::int2048_t>());

	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::uint128_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::uint256_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::uint512_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::uint1024_t>());
	EXPECT_TRUE(ShiftLeftEqualTest2<hamon::uint2048_t>());
}
