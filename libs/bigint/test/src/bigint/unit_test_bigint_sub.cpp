...
GTEST_TEST(BigIntTest, SubTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::inplace_bigint<512>>());
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubTest2<hamon::inplace_bigint<128>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubTest2<hamon::inplace_bigint<256>>());
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE(SubTest2<hamon::inplace_bigint<512>>());
