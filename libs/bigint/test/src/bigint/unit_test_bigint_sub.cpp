...
GTEST_TEST(BigIntTest, SubTest)
{
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::int1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::int2048_t>());
	...
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::uint1024_t>());
	HAMON_CXX14_CONSTEXPR_EXPECT_TRUE(SubTest<hamon::uint2048_t>());

	EXPECT_TRUE(SubTest2<hamon::bigint>());

	EXPECT_TRUE(SubTest2<hamon::int128_t>());
	EXPECT_TRUE(SubTest2<hamon::int256_t>());
	EXPECT_TRUE(SubTest2<hamon::int512_t>());
	EXPECT_TRUE(SubTest2<hamon::int1024_t>());
	EXPECT_TRUE(SubTest2<hamon::int2048_t>());

	EXPECT_TRUE(SubTest2<hamon::uint128_t>());
	EXPECT_TRUE(SubTest2<hamon::uint256_t>());
	EXPECT_TRUE(SubTest2<hamon::uint512_t>());
	EXPECT_TRUE(SubTest2<hamon::uint1024_t>());
	EXPECT_TRUE(SubTest2<hamon::uint2048_t>());
}
