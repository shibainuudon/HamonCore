/**
 *	@file	unit_test_flat_set_lower_bound.cpp
 *
...
FLAT_SET_TEST_CONSTEXPR bool test()
{
...

	{
		...
		VERIFY(v.lower_bound(Key{3}) == (v.begin() + 1));
		VERIFY(v.lower_bound(Key{4}) == (v.begin() + 2));
		VERIFY(v.lower_bound(Key{5}) == (v.begin() + 3));
		VERIFY(v.lower_bound(Key{6}) == (v.begin() + 3));
		VERIFY(v.lower_bound(Key{7}) == v.end());

		auto const& cv = v;
		VERIFY(cv.lower_bound(Key{0}) == (cv.begin() + 0));
		VERIFY(cv.lower_bound(Key{1}) == (cv.begin() + 0));
		VERIFY(cv.lower_bound(Key{2}) == (cv.begin() + 1));
		VERIFY(cv.lower_bound(Key{3}) == (cv.begin() + 1));
		VERIFY(cv.lower_bound(Key{4}) == (cv.begin() + 2));
		VERIFY(cv.lower_bound(Key{5}) == (cv.begin() + 3));
		VERIFY(cv.lower_bound(Key{6}) == (cv.begin() + 3));
		VERIFY(cv.lower_bound(Key{7}) == cv.end());
	}
	{
		...
		VERIFY(v.lower_bound(Key{1}) == (v.begin() + 3));
		VERIFY(v.lower_bound(Key{2}) == (v.begin() + 3));
		VERIFY(v.lower_bound(Key{3}) == (v.begin() + 2));
		VERIFY(v.lower_bound(Key{4}) == (v.begin() + 1));
		VERIFY(v.lower_bound(Key{5}) == (v.begin() + 1));
		VERIFY(v.lower_bound(Key{6}) == (v.begin() + 0));
		VERIFY(v.lower_bound(Key{7}) == (v.begin() + 0));

		auto const& cv = v;
		VERIFY(cv.lower_bound(Key{0}) == cv.end());
		VERIFY(cv.lower_bound(Key{1}) == (cv.begin() + 3));
		VERIFY(cv.lower_bound(Key{2}) == (cv.begin() + 3));
		VERIFY(cv.lower_bound(Key{3}) == (cv.begin() + 2));
		VERIFY(cv.lower_bound(Key{4}) == (cv.begin() + 1));
		VERIFY(cv.lower_bound(Key{5}) == (cv.begin() + 1));
		VERIFY(cv.lower_bound(Key{6}) == (cv.begin() + 0));
		VERIFY(cv.lower_bound(Key{7}) == (cv.begin() + 0));
	}
...
GTEST_TEST(FlatSetTest, LowerBoundTest)
{
