/**
 *	@file	unit_test_flat_set_emplace.cpp
 *
 *	@brief	emplace のテスト
 *
 *	template<class... Args>
...
FLAT_SET_TEST_CONSTEXPR bool test()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<Set&>().emplace()), Result>::value, "");
	...
	static_assert(hamon::is_same<decltype(hamon::declval<Set&>().emplace(hamon::declval<Key>())), Result>::value, "");
...
GTEST_TEST(FlatSetTest, EmplaceTest)
{
