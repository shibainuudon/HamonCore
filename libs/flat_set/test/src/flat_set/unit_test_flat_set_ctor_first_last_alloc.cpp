/**
 *	@file	unit_test_flat_set_ctor_first_last_alloc.cpp
 *
...
FLAT_SET_TEST_CONSTEXPR bool test_impl()
{
	...
	static_assert( hamon::is_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Alloc const&>::value, "");
	static_assert( hamon::is_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Compare const&, Alloc const&>::value, "");
	...
	static_assert(!hamon::is_nothrow_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Alloc const&>::value, "");
	static_assert(!hamon::is_nothrow_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Compare const&, Alloc const&>::value, "");
	...
	static_assert( hamon::is_implicitly_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Alloc const&>::value, "");
	static_assert( hamon::is_implicitly_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Compare const&, Alloc const&>::value, "");
	...
	static_assert(!hamon::is_trivially_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Alloc const&>::value, "");
	static_assert(!hamon::is_trivially_constructible<Set, hamon::sorted_unique_t, InputIterator, InputIterator, Compare const&, Alloc const&>::value, "");
	...
	}
	{
		...
		Alloc const alloc;
		hamon::flat_set<Key, TestLess<Key>, KeyContainer> v{InputIterator{hamon::ranges::begin(a)}, InputIterator{hamon::ranges::end(a)}, comp, alloc};
		VERIFY(check_invariant(v));
		VERIFY(v.size() == 3);
	...
	}
	{
		...
		Alloc const alloc;
		Set v{hamon::sorted_unique, InputIterator{hamon::ranges::begin(a)}, InputIterator{hamon::ranges::end(a)}, alloc};
		VERIFY(check_invariant(v));
		VERIFY(!v.empty());
		VERIFY(v.size() == 3);
		VERIFY(v.count(Key{0}) == 0);
	...
	}
	{
		...
		Alloc const alloc;
		hamon::flat_set<Key, TestLess<Key>, KeyContainer> v{hamon::sorted_unique, InputIterator{hamon::ranges::begin(a)}, InputIterator{hamon::ranges::end(a)}, comp, alloc};
		VERIFY(check_invariant(v));
		VERIFY(!v.empty());
		VERIFY(v.size() == 4);
		VERIFY(v.key_comp() == comp);
...
GTEST_TEST(FlatSetTest, CtorFirstLastAllocTest)
{
