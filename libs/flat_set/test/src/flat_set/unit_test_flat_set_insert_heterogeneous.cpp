/**
 *	@file	unit_test_flat_set_insert_heterogeneous.cpp
 *
 *	@brief	insert のテスト
 *
...
void test_exceptions()
{
	...
	using Comp = hamon::less<>;
	{
		...
		EXPECT_THROW(v.insert(0), std::bad_alloc);
