/**
 *	@file	unit_test_flat_set_insert_init_list.cpp
 *
 *	@brief	insert のテスト
 *
...
FLAT_SET_TEST_CONSTEXPR bool test()
{
	...
	{
		hamon::flat_set<Key, hamon::less<Key>, KeyContainer> v;
		VERIFY(check_invariant(v));
	...
	{
		hamon::flat_set<Key, hamon::greater<Key>, KeyContainer> v;
		VERIFY(check_invariant(v));
...
GTEST_TEST(FlatSetTest, InsertInitListTest)
{
