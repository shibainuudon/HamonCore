/**
 *	@file	unit_test_flat_multiset_dtor.cpp
 *
 *	@brief	デストラクタのテスト
 */
...
GTEST_TEST(FlatMultisetTest, DtorTest)
{
	...
	FLAT_SET_TEST_CONSTEXPR_EXPECT_TRUE((test<MinSequenceContainer<char>, hamon::less<int>>()));
}
