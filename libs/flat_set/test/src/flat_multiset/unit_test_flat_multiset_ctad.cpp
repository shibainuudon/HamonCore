/**
 *	@file	unit_test_flat_multiset_ctad.cpp
 *
...
FLAT_SET_TEST_CONSTEXPR bool test1()
{
	...
	// (key_cont)
	{
		...
		hamon::flat_multiset v(key_cont);
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, DefaultCompare, KeyContainer>>::value, "");
	...
	// (key_cont, comp)
	{
		...
		Compare const comp;
		hamon::flat_multiset v{key_cont, comp};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (key_cont, alloc)
	{
		...
		Alloc const alloc;
		hamon::flat_multiset v{key_cont, alloc};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, DefaultCompare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (key_cont, comp, alloc)
	{
		...
		Compare const comp;
		Alloc const alloc;
		hamon::flat_multiset v{key_cont, comp, alloc};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}

	// (sorted_equivalent, key_cont)
	{
		KeyContainer key_cont {Key{3}, Key{1}};
		hamon::ranges::sort(key_cont, DefaultCompare{});
		hamon::flat_multiset v{hamon::sorted_equivalent, key_cont};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, DefaultCompare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (sorted_equivalent, key_cont, comp)
	{
		KeyContainer key_cont {Key{3}, Key{1}, Key{4}, Key{1}};
		Compare const comp;
		hamon::ranges::sort(key_cont, comp);
		hamon::flat_multiset v{hamon::sorted_equivalent, key_cont, comp};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (sorted_equivalent, key_cont, alloc)
	{
		KeyContainer key_cont {Key{3}, Key{1}, Key{4}};
		Alloc const alloc;
		hamon::ranges::sort(key_cont, DefaultCompare{});
		hamon::flat_multiset v{hamon::sorted_equivalent, key_cont, alloc};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, DefaultCompare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (sorted_equivalent, key_cont, comp, alloc)
	{
		KeyContainer key_cont {Key{3}, Key{1}, Key{4}, Key{1}, Key{5}};
		Compare const comp;
		Alloc const alloc;
		hamon::ranges::sort(key_cont, comp);
		hamon::flat_multiset v{hamon::sorted_equivalent, key_cont, comp, alloc};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare, KeyContainer>>::value, "");
		VERIFY(check_invariant(v));
	}
...
FLAT_SET_TEST_CONSTEXPR bool test2_impl()
{
	...
	// (first, last)
	{
		hamon::flat_multiset v(InputIterator{a}, InputIterator{a + 3});
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (first, last, comp)
	{
		Compare const comp;
		hamon::flat_multiset v{InputIterator{a}, InputIterator{a + 3}, comp};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare>>::value, "");
		VERIFY(check_invariant(v));
	}

	// (sorted_equivalent, first, last)
	{
		hamon::flat_multiset v{hamon::sorted_equivalent, InputIterator{a}, InputIterator{a + 3}};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (sorted_equivalent, first, last, comp)
	{
		...
		hamon::flat_multiset v{hamon::sorted_equivalent, InputIterator{a}, InputIterator{a + 3}, comp};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, hamon::less<>>>::value, "");
		VERIFY(check_invariant(v));
	}
...
FLAT_SET_TEST_CONSTEXPR bool test3_impl()
{
	...
	// (from_range, rg)
	{
		hamon::flat_multiset v{hamon::from_range, Range{a}};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key>>::value, "");
		VERIFY(check_invariant(v));
	}
	...
	{
		Compare const comp;
		hamon::flat_multiset v{hamon::from_range, Range{a}, comp};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (from_range, rg, compare, alloc)
	{
		Compare const comp;
		Alloc const alloc;
		hamon::flat_multiset v{hamon::from_range, Range{a}, comp, alloc};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, Compare>>::value, "");
		VERIFY(check_invariant(v));
	}
	// (from_range, rg, alloc)
	{
		Alloc const alloc;
		hamon::flat_multiset v{hamon::from_range, Range{a}, alloc};
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key>>::value, "");
		VERIFY(check_invariant(v));
	}
...
FLAT_SET_TEST_CONSTEXPR bool test4()
{
	...
	// (sorted_equivalent, initializer_list, comp)
	{
		...
		static_assert(hamon::is_same<decltype(v), hamon::flat_multiset<Key, hamon::greater<>>>::value, "");
		VERIFY(check_invariant(v));
	}
