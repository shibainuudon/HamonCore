/**
 *	@file	unit_test_flat_multiset_find_heterogeneous.cpp
 *
 *	@brief	find のテスト
 *
...
GTEST_TEST(FlatMultisetTest, FindHeterogeneousTest)
{
	...
	{
		hamon::flat_multiset<hamon::string, hamon::less<>> fs = {"Alice", "Bob", "Carol"};
