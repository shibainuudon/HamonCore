...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<Set&>().insert(hamon::sorted_equivalent, hamon::declval<hamon::initializer_list<ValueType>>())), void>::value, "");
	static_assert(!noexcept(hamon::declval<Set&>().insert(hamon::declval<hamon::initializer_list<ValueType>>())), "");
	static_assert(!noexcept(hamon::declval<Set&>().insert(hamon::sorted_equivalent, hamon::declval<hamon::initializer_list<ValueType>>())), "");
