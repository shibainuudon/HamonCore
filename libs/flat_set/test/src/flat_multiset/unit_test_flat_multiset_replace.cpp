/**
 *	@file	unit_test_flat_multiset_replace.cpp
 *
 *	@brief	replace のテスト
 *
...
GTEST_TEST(FlatMultisetTest, ReplaceTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE((test<MinSequenceContainer<float>, hamon::greater<float>>()));
