/**
 *	@file	flat_multiset_test_helper.hpp
 *
 *	@brief
 */

#ifndef HAMON_FLAT_MULTISET_TEST_HELPER_HPP
#define HAMON_FLAT_MULTISET_TEST_HELPER_HPP
...
template <typename FlatMultiset>
HAMON_CXX14_CONSTEXPR bool
check_invariant(FlatMultiset const& v)
{
...
#endif // HAMON_FLAT_MULTISET_TEST_HELPER_HPP
