/**
 *	@file	unit_test_flat_multiset_ctor_init_list_alloc.cpp
 *
 ...
 *
 *	template<class Alloc>
 *	constexpr flat_multiset(sorted_equivalent_t, initializer_list<value_type> il, const key_compare& comp, const Alloc& a);
 */
...
GTEST_TEST(FlatMultisetTest, CtorInitListAllocTest)
{
