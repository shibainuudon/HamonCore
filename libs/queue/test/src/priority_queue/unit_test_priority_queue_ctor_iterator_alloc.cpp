/**
 *	@file	unit_test_priority_queue_ctor_iterator_alloc.cpp
 *
...
PRIORITY_QUEUE_TEST_CONSTEXPR bool test_impl()
{
...

	{
		...
		static_assert(!hamon::is_nothrow_constructible<Queue, Iterator, Iterator, Alloc const&>::value, "");
...
GTEST_TEST(PriorityQueueTest, CtorIteratorAllocTest)
{
