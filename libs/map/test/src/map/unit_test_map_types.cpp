...
GTEST_TEST(MapTest, TypesTest)
{
	...
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE((test<char, float, hamon::less<>, std::allocator>()));
	HAMON_CXX20_CONSTEXPR_EXPECT_TRUE((test<float, int, hamon::greater<>, hamon::allocator>()));
}
