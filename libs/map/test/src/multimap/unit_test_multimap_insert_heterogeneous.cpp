/**
 *	@file	unit_test_multimap_insert_heterogeneous.cpp
 *
 *	@brief	insert のテスト
 *
...
MULTIMAP_TEST_CONSTEXPR bool test1()
{
	...
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::pair<int, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::pair<char, double>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::pair<char, float>>())), Iterator>::value, "");
	...
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::tuple<int, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::tuple<char, double>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::tuple<char, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::array<int, 2>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::array<double, 2>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<std::array<char, 2>>())), Iterator>::value, "");
...
#if !defined(HAMON_USE_STD_MULTIMAP)
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::pair<int, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::pair<char, double>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::pair<char, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::tuple<int, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::tuple<char, double>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::tuple<char, float>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::array<int, 2>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::array<double, 2>>())), Iterator>::value, "");
	static_assert(hamon::is_same<decltype(v.insert(hamon::declval<hamon::array<char, 2>>())), Iterator>::value, "");
...
GTEST_TEST(MultimapTest, InsertHeterogeneousTest)
{
