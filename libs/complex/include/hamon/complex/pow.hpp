...
template <typename T>
HAMON_NODISCARD HAMON_CXX11_CONSTEXPR complex<T>
pow(complex<T> const& x, T const& y)
{
...
template <typename T>
HAMON_NODISCARD HAMON_CXX11_CONSTEXPR complex<T>
pow(T const& x, complex<T> const& y)
{
	return hamon::pow(complex<T>{x}, y);
}

template <typename T1, typename T2>
HAMON_NODISCARD HAMON_CXX11_CONSTEXPR hamon::complex<hamon::common_type_t<T1, T2>>
pow(complex<T1> const& x, complex<T2> const& y)
{
	return hamon::pow(
...
template <typename T1, typename T2>
HAMON_NODISCARD HAMON_CXX11_CONSTEXPR hamon::complex<hamon::common_type_t<T1, T2>>
pow(complex<T1> const& x, T2 const& y)
{
	return hamon::pow(
		hamon::complex<hamon::common_type_t<T1, T2>>(x),
...
template <typename T1, typename T2>
HAMON_NODISCARD HAMON_CXX11_CONSTEXPR hamon::complex<hamon::common_type_t<T1, T2>>
pow(T1 const& x, complex<T2> const& y)
{
	return hamon::pow(
