...
GTEST_TEST(NumericTest, AccumulateTest)
{
	...
	{
		HAMON_CONSTEXPR_OR_CONST int a[] = { 1, 2, 3, 4 };
		HAMON_CXX14_CONSTEXPR auto x1 = hamon::accumulate(hamon::begin(a), hamon::end(a), 0);
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(10, x1);
		HAMON_CXX14_CONSTEXPR auto x2 = hamon::accumulate(hamon::begin(a), hamon::end(a), 10);
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(20, x2);
		HAMON_CXX14_CONSTEXPR auto x3 = hamon::accumulate(hamon::begin(a), hamon::end(a), 1, hamon::multiplies<>());
		HAMON_CXX14_CONSTEXPR_EXPECT_EQ(24, x3);
	}
	{
		HAMON_CONSTEXPR_OR_CONST std::array<int, 5> a = {{ 11, 12, 13, 14, 15 }};
		HAMON_CXX17_CONSTEXPR auto x1 = hamon::accumulate(hamon::begin(a), hamon::end(a), 0);
		HAMON_CXX17_CONSTEXPR_EXPECT_EQ(65, x1);
		HAMON_CXX17_CONSTEXPR auto x2 = hamon::accumulate(hamon::begin(a), hamon::end(a), -20);
		HAMON_CXX17_CONSTEXPR_EXPECT_EQ(45, x2);
		HAMON_CXX17_CONSTEXPR auto x3 = hamon::accumulate(hamon::begin(a), hamon::end(a), 1, hamon::multiplies<>());
		HAMON_CXX17_CONSTEXPR_EXPECT_EQ(360360, x3);
	}
}
