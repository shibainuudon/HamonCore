...
static_assert(hamon::is_same<hamon::iter_common_reference_t<std::vector<float>::iterator>, float&>::value, "");
static_assert(hamon::is_same<hamon::iter_common_reference_t<std::vector<float>::const_iterator>, float const&>::value, "");
