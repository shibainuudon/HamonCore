...
static_assert( hamon::indirectly_readable<TestIter1 const>, "");
...
static_assert(!hamon::indirectly_readable<TestIter2 const>, "");
...
static_assert( hamon::indirectly_readable<TestIter3 const>, "");
...
static_assert( hamon::indirectly_readable<TestIter4 const>, "");
...
static_assert( hamon::indirectly_readable<TestIter5 const>, "");
...
static_assert( hamon::indirectly_readable<TestIter6 const>, "");
