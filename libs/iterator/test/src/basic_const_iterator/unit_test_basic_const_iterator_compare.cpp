...
static_assert( hamon::equality_comparable<hamon::basic_const_iterator<input_iterator_wrapper<int>>>, "");
static_assert( hamon::equality_comparable<hamon::basic_const_iterator<forward_iterator_wrapper<int>>>, "");
static_assert( hamon::equality_comparable<hamon::basic_const_iterator<bidirectional_iterator_wrapper<int>>>, "");
static_assert( hamon::equality_comparable<hamon::basic_const_iterator<random_access_iterator_wrapper<int>>>, "");
static_assert( hamon::equality_comparable<hamon::basic_const_iterator<contiguous_iterator_wrapper<int>>>, "");

static_assert(!hamon::totally_ordered<hamon::basic_const_iterator<input_iterator_wrapper<int>>>, "");
static_assert(!hamon::totally_ordered<hamon::basic_const_iterator<forward_iterator_wrapper<int>>>, "");
static_assert(!hamon::totally_ordered<hamon::basic_const_iterator<bidirectional_iterator_wrapper<int>>>, "");
static_assert( hamon::totally_ordered<hamon::basic_const_iterator<random_access_iterator_wrapper<int>>>, "");
static_assert( hamon::totally_ordered<hamon::basic_const_iterator<contiguous_iterator_wrapper<int>>>, "");

static_assert(!hamon::equality_comparable_with<hamon::basic_const_iterator<input_iterator_wrapper<int>>, forward_iterator_wrapper<int>>, "");
static_assert( hamon::equality_comparable_with<hamon::basic_const_iterator<input_iterator_wrapper<int>>, input_iterator_wrapper<int>>, "");
static_assert( hamon::equality_comparable_with<hamon::basic_const_iterator<forward_iterator_wrapper<int>>, forward_iterator_wrapper<int>>, "");
static_assert( hamon::equality_comparable_with<hamon::basic_const_iterator<bidirectional_iterator_wrapper<int>>, bidirectional_iterator_wrapper<int>>, "");
...
static_assert( hamon::equality_comparable_with<forward_iterator_wrapper<int>, hamon::basic_const_iterator<forward_iterator_wrapper<int>>>, "");
static_assert( hamon::equality_comparable_with<bidirectional_iterator_wrapper<int>, hamon::basic_const_iterator<bidirectional_iterator_wrapper<int>>>, "");
...
static_assert( hamon::detail::weakly_equality_comparable_with<hamon::basic_const_iterator<bidirectional_iterator_wrapper<int>>, test_sentinel<bidirectional_iterator_wrapper<int>>>, "");
static_assert( hamon::detail::weakly_equality_comparable_with<hamon::basic_const_iterator<random_access_iterator_wrapper<int>>, test_sentinel<random_access_iterator_wrapper<int>>>, "");
static_assert( hamon::detail::weakly_equality_comparable_with<hamon::basic_const_iterator<contiguous_iterator_wrapper<int>>, test_sentinel<contiguous_iterator_wrapper<int>>>, "");
static_assert(!hamon::detail::weakly_equality_comparable_with<hamon::basic_const_iterator<input_iterator_wrapper<int>>, test_sentinel<forward_iterator_wrapper<int>>>, "");
static_assert(!hamon::detail::weakly_equality_comparable_with<hamon::basic_const_iterator<input_iterator_wrapper<int>>, test_sentinel<input_iterator_wrapper<int const>>>, "");
