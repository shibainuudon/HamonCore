...
static_assert(hamon::is_same<hamon::incrementable_traits<T      *                   >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T const*                   >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T      * const             >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T const* const             >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T[3]                       >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T const[3]                 >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T[]                        >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<T const[]                  >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<vec_iterator               >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<vec_iterator const         >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<vec_const_iterator         >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<vec_const_iterator const   >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<std::vector<T>           >::difference_type, std::ptrdiff_t>::value, "");
static_assert(hamon::is_same<hamon::incrementable_traits<std::vector<T> const     >::difference_type, std::ptrdiff_t>::value, "");
