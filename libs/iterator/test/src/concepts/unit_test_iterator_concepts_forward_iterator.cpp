...
HAMON_FORWARD_ITERATOR_TEST(true,  std::list<int>::iterator);
HAMON_FORWARD_ITERATOR_TEST(true,  std::list<A>::const_iterator);
HAMON_FORWARD_ITERATOR_TEST(true,  std::string::iterator);
HAMON_FORWARD_ITERATOR_TEST(true,  std::string::const_iterator);
//HAMON_FORWARD_ITERATOR_TEST(true,  std::string_view::iterator);
//HAMON_FORWARD_ITERATOR_TEST(true,  std::string_view::const_iterator);
HAMON_FORWARD_ITERATOR_TEST(true,  std::vector<int>::iterator);
HAMON_FORWARD_ITERATOR_TEST(true,  std::vector<A>::const_iterator);
