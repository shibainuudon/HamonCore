...
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(true,  int*, hamon::vector<int>::iterator);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(false, int*, hamon::vector<int>::const_iterator);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(true,  hamon::vector<int>::iterator, int*);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(true,  hamon::vector<int>::iterator, hamon::vector<int>::iterator);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(false, hamon::vector<int>::iterator, hamon::vector<int>::const_iterator);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(true,  hamon::vector<int>::const_iterator, int*);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(true,  hamon::vector<int>::const_iterator, hamon::vector<int>::iterator);
HAMON_INDIRECTLY_COPYABLE_STORABLE_TEST(false, hamon::vector<int>::const_iterator, hamon::vector<int>::const_iterator);
