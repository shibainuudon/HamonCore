...
HAMON_MERGEABLE_TEST(true,  std::list<int>::iterator, hamon::array<int, 2>::iterator, std::vector<int>::iterator);
HAMON_MERGEABLE_TEST(false, std::list<int>::iterator, hamon::array<int, 2>::iterator, std::vector<int>::const_iterator);
