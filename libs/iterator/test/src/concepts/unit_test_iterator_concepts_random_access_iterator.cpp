...
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::deque<int>::iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::deque<A>::const_iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(false, hamon::list<int>::iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(false, hamon::list<A>::const_iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::string::iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::string::const_iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::string_view::iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::string_view::const_iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::vector<int>::iterator);
HAMON_RANDOM_ACCESS_ITERATOR_TEST(true,  hamon::vector<A>::const_iterator);
