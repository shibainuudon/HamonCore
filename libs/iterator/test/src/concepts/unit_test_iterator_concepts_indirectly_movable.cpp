...
HAMON_INDIRECTLY_MOVABLE_TEST(true,  int*, std::vector<int>::iterator);
HAMON_INDIRECTLY_MOVABLE_TEST(false, int*, std::vector<int>::const_iterator);
HAMON_INDIRECTLY_MOVABLE_TEST(true,  std::vector<int>::iterator, int*);
HAMON_INDIRECTLY_MOVABLE_TEST(true,  std::vector<int>::iterator, std::vector<int>::iterator);
HAMON_INDIRECTLY_MOVABLE_TEST(false, std::vector<int>::iterator, std::vector<int>::const_iterator);
HAMON_INDIRECTLY_MOVABLE_TEST(true,  std::vector<int>::const_iterator, int*);
HAMON_INDIRECTLY_MOVABLE_TEST(true,  std::vector<int>::const_iterator, std::vector<int>::iterator);
HAMON_INDIRECTLY_MOVABLE_TEST(false, std::vector<int>::const_iterator, std::vector<int>::const_iterator);
