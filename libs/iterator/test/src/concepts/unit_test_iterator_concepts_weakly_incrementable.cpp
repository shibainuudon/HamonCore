...
HAMON_WEAKLY_INCREMENTABLE_TEST(false, std::vector<int>);
HAMON_WEAKLY_INCREMENTABLE_TEST(true,  std::vector<int>::iterator);
HAMON_WEAKLY_INCREMENTABLE_TEST(true,  std::vector<int>::const_iterator);
