...
{
	{
		...
		static_assert(!hamon::indirectly_copyable_storable<int*, iterator>, "");
		static_assert( hamon::indirectly_readable<iterator>, "");
		static_assert(!hamon::indirectly_writable<iterator, int>, "");
