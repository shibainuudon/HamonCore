...
static_assert(hamon::is_same<hamon::indirect_result_t<int(int), std::vector<int>::iterator>, int>::value, "");
static_assert(hamon::is_same<hamon::indirect_result_t<int(int), std::vector<int>::const_iterator>, int>::value, "");
...
static_assert(hamon::is_same<hamon::indirect_result_t<float(int, int), int*, std::vector<int>::iterator>, float>::value, "");
static_assert(hamon::is_same<hamon::indirect_result_t<float(int, int), int*, std::vector<int>::const_iterator>, float>::value, "");
