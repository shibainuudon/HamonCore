...
private:
	template <typename F2, typename J1, typename J2,
		...
		typename = hamon::enable_if_t<hamon::predicate<F2&, V1, V2>>,
		typename = hamon::enable_if_t<hamon::predicate<F2&, V1, R2>>,
		typename = hamon::enable_if_t<hamon::predicate<F2&, R1, V2>>,
		typename = hamon::enable_if_t<hamon::predicate<F2&, R1, R2>>,
		typename = hamon::enable_if_t<hamon::predicate<F2&, C1, C2>>
	>
