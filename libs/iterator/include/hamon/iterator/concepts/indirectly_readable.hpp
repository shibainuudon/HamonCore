...
private:
	template <typename U,
		...
		typename = hamon::enable_if_t<hamon::common_reference_with<R&&, V&>>,
		typename = hamon::enable_if_t<hamon::common_reference_with<R&&, RR&&>>,
		typename = hamon::enable_if_t<hamon::common_reference_with<RR&&, V const&>>
	>
