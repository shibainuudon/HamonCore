...
concept indirect_equivalence_relation =
	...
	hamon::equivalence_relation<F&, hamon::detail::indirect_value_t<I1>, hamon::detail::indirect_value_t<I2>> &&
	hamon::equivalence_relation<F&, hamon::detail::indirect_value_t<I1>, hamon::iter_reference_t<I2>> &&
	hamon::equivalence_relation<F&, hamon::iter_reference_t<I1>, hamon::detail::indirect_value_t<I2>> &&
...
private:
	template <typename F2, typename J1, typename J2,
		...
		typename = hamon::enable_if_t<hamon::equivalence_relation<F2&, V1, V2>>,
		typename = hamon::enable_if_t<hamon::equivalence_relation<F2&, V1, R2>>,
		typename = hamon::enable_if_t<hamon::equivalence_relation<F2&, R1, V2>>,
		typename = hamon::enable_if_t<hamon::equivalence_relation<F2&, R1, R2>>,
		typename = hamon::enable_if_t<hamon::equivalence_relation<F2&, C1, C2>>
	>
