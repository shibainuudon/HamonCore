...
#ifndef HAMON_ITERATOR_CONCEPTS_INDIRECTLY_REGULAR_UNARY_INVOCABLE_HPP
#define HAMON_ITERATOR_CONCEPTS_INDIRECTLY_REGULAR_UNARY_INVOCABLE_HPP
...
private:
	template <typename F2, typename I2,
		...
		typename = hamon::enable_if_t<hamon::regular_invocable<F2&, V>>,
		typename R = hamon::iter_reference_t<I2>,
		typename = hamon::enable_if_t<hamon::regular_invocable<F2&, R>>,
		typename C = hamon::iter_common_reference_t<I2>,
		typename = hamon::enable_if_t<hamon::regular_invocable<F2&, C>>,
...
#endif // HAMON_ITERATOR_CONCEPTS_INDIRECTLY_REGULAR_UNARY_INVOCABLE_HPP
