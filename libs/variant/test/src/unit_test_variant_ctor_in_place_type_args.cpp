...
static_assert(!hamon::is_constructible<hamon::variant<int>, hamon::in_place_type_t<int>,   hamon::string>::value, "");
...
static_assert( hamon::is_constructible<hamon::variant<hamon::string>, hamon::in_place_type_t<hamon::string>, char const*>::value, "");
static_assert( hamon::is_constructible<hamon::variant<hamon::string>, hamon::in_place_type_t<hamon::string>, char const*, int>::value, "");
static_assert( hamon::is_constructible<hamon::variant<hamon::string>, hamon::in_place_type_t<hamon::string>, int, char>::value, "");
static_assert(!hamon::is_constructible<hamon::variant<hamon::string>, hamon::in_place_type_t<hamon::string>, int, char const*>::value, "");
...
GTEST_TEST(VariantTest, CtorInPlaceTypeArgsTest)
{
	...
	}
	{
		hamon::variant<hamon::string> v(
			hamon::in_place_type_t<hamon::string>{}, 3u, 'a');
	...
	{
		hamon::variant<int, char, hamon::string> v(
			hamon::in_place_type_t<hamon::string>{}, 4u, 'b');
