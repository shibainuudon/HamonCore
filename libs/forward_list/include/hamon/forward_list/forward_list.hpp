...
public:
	...
	HAMON_CXX14_CONSTEXPR
	forward_list(hamon::initializer_list<T> il, Allocator const& a = Allocator())
	...
	HAMON_CXX14_CONSTEXPR
	forward_list& operator=(hamon::initializer_list<T> il)
	{
		// [sequence.reqmts]/17
		static_assert(hamon::detail::cpp17_copy_insertable<value_type, allocator_type>, "");
		static_assert(hamon::detail::cpp17_copy_assignable<value_type>, "");
	...
	HAMON_CXX14_CONSTEXPR
	void assign(hamon::initializer_list<T> il)
	{
		// [sequence.reqmts]/65
		this->assign(il.begin(), il.end());
	}
	...
	HAMON_CXX14_CONSTEXPR
	iterator insert_after(const_iterator position, hamon::initializer_list<T> il)
	{
