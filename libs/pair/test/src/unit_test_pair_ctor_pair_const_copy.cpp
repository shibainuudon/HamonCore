/**
 *	@file	unit_test_pair_ctor_pair_const_copy.cpp
 *
...
namespace ctor_pair_const_copy_test
{
...
GTEST_TEST(PairTest, CtorPairConstCopyTest)
{
	{
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::pair<Explicit, Explicit> p2(p1);
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::pair<Explicit, Implicit> p2(p1);
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::pair<Implicit, Explicit> p2 {p1};
	...
	}
	{
		...
		HAMON_CXX11_CONSTEXPR hamon::pair<Implicit, Implicit> p2 = {p1};
