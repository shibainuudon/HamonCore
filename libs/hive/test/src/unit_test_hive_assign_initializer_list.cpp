...
HAMON_CXX20_CONSTEXPR bool test()
{
	...
	static_assert(hamon::is_same<decltype(hamon::declval<Hive>().assign(hamon::declval<hamon::initializer_list<T>>())), void>::value, "");
	static_assert(!noexcept(hamon::declval<Hive>().assign(hamon::declval<hamon::initializer_list<T>>())), "");
