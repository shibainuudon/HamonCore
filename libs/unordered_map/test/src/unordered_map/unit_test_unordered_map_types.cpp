...
{
	UNORDERED_MAP_TEST_CONSTEXPR_EXPECT_TRUE((test<int, char, hamon::hash<int>, hamon::equal_to<int>, hamon::allocator<std::pair<const int, char>>>()));
	UNORDERED_MAP_TEST_CONSTEXPR_EXPECT_TRUE((test<char, float, hamon::hash<char>, hamon::equal_to<>, hamon::allocator<std::pair<const char, float>>>()));
	UNORDERED_MAP_TEST_CONSTEXPR_EXPECT_TRUE((test<float, int, decltype(hamon::ranges::hash), hamon::equal_to<>, hamon::allocator<std::pair<const float, int>>>()));
}
