...
UNORDERED_MAP_TEST_CONSTEXPR bool test1()
{
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(Key{1}));
		VERIFY(r != v1.end());
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(Key{2}));
		VERIFY(r == v1.end());
	}
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(Key{3}));
		VERIFY(r != v1.end());
	...
	{
		auto r = v1.insert(v1.cend(), v2.extract(v2.begin()));
		VERIFY(r != v1.end());
		VERIFY(r->first == Key{4});
...
UNORDERED_MAP_TEST_CONSTEXPR bool test2()
{
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(Key{2}));
		VERIFY(r != v1.end());
		VERIFY(r->first == Key{2});
		VERIFY(r->second == T{11});
	}
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(Key{3}));
		VERIFY(r == v1.end());
	}
	...
	{
		auto r = v1.insert(v1.cbegin(), v2.extract(Key{4}));
		VERIFY(r != v1.end());
		VERIFY(r->first == Key{4});
		VERIFY(r->second == T{15});
	}
...
UNORDERED_MAP_TEST_CONSTEXPR bool test3()
{
	...
	{
		auto r = v2.insert(v2.begin(), v1.extract(Key{0}));
		VERIFY(r == v2.end());
	}
	...
	{
		auto r = v2.insert(v2.begin(), v1.extract(Key{1}));
		VERIFY(r != v2.end());
		VERIFY(r->first == Key{1});
	...
	{
		auto r = v2.insert(v2.begin(), v1.extract(Key{2}));
		VERIFY(r != v2.end());
		VERIFY(r->first == Key{2});
