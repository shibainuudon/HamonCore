/**
 *	@file	unit_test_unordered_multimap_ctor_copy_allocator.cpp
 *
...
UNORDERED_MULTIMAP_TEST_CONSTEXPR bool test()
{
	...
	}
	{
		...
		Map const v2{v1, v1.get_allocator()};
...
GTEST_TEST(UnorderedMultimapTest, CtorCopyAllocatorTest)
{
