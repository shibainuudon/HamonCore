/**
 *	@file	unordered_multimap_test_helper.hpp
 *
 *	@brief
 */

#ifndef HAMON_UNORDERED_MULTIMAP_TEST_HELPER_HPP
#define HAMON_UNORDERED_MULTIMAP_TEST_HELPER_HPP
...
#endif // HAMON_UNORDERED_MULTIMAP_TEST_HELPER_HPP
