/**
 *	@file	unit_test_unordered_multimap_insert_move.cpp
 *
 *	@brief	insert のテスト
 *
...
GTEST_TEST(UnorderedMultimapTest, InsertMoveTest)
{
	...
	{
		using Map = hamon::unordered_multimap<int, ThrowOnMove>;
		using ValueType = typename Map::value_type;
