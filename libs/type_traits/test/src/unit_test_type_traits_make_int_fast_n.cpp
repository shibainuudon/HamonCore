...
static_assert(hamon::is_signed<hamon::make_int_fast_n_t<65>>::value, "");
static_assert(hamon::is_signed<hamon::make_int_fast_n_t<127>>::value, "");
static_assert(hamon::is_signed<hamon::make_int_fast_n_t<128>>::value, "");
#endif
...
#if defined(HAMON_HAS_INT128)
static_assert(sizeof(hamon::make_int_fast_n_t<65>) >= 16, "");
static_assert(sizeof(hamon::make_int_fast_n_t<127>) >= 16, "");
static_assert(sizeof(hamon::make_int_fast_n_t<128>) >= 16, "");
#endif
