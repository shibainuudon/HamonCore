...
static_assert(hamon::is_same<Type1::value_type, int>::value, "");
static_assert(hamon::is_same<Type1::type, Type1>::value, "");
...
static_assert(hamon::is_same<Type2::value_type, int>::value, "");
static_assert(hamon::is_same<Type2::type, Type2>::value, "");
...
static_assert(hamon::is_same<Type3::value_type, unsigned char>::value, "");
static_assert(hamon::is_same<Type3::type, Type3>::value, "");
