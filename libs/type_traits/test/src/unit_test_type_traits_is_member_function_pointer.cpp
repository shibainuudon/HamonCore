...
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(false, char(UDT::*));
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(false, char(UDT::* const));
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(false, char(UDT::* volatile));
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(false, char(UDT::* const volatile));
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(false, int*(UDT::*));
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(false, void*(UDT::*));
...
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int    (UDT::* const volatile)(char const*  , ...)       volatile&&);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int    (UDT::* const volatile)(char, char   , ...) const volatile&&);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int    (UDT::*               )(             )                noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  char   (UDT::*               )(int          ) const          noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  short  (UDT::*               )(float        )       volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  long   (UDT::*               )(double       ) const volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  float  (UDT::* const         )(int, int     )                noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  double (UDT::* const         )(int, int, int) const          noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  void   (UDT::* const         )(char         )       volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int*   (UDT::* const         )(char*        ) const volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  char*  (UDT::*       volatile)(int&         )                noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  short* (UDT::*       volatile)(int*         ) const          noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  long*  (UDT::*       volatile)(long         )       volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  float* (UDT::*       volatile)(short        ) const volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  double*(UDT::* const volatile)(const long&  )                noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  void*  (UDT::* const volatile)(const int&   ) const          noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int    (UDT::* const volatile)(char const*  )       volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int    (UDT::* const volatile)(char, char   ) const volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  int    (UDT::*               )(...)                               noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  char   (UDT::*               )(int          , ...) const          noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  short  (UDT::*               )(float        , ...)       volatile noexcept);
HAMON_IS_MEMBER_FUNCTION_POINTER_TEST(true,  long   (UDT::*               )(double       , ...) const volatile noexcept);
