...
#define HAMON_MAKE_UNSIGNED_TEST_1(T)	\
	static_assert(hamon::is_integral<hamon::make_unsigned<T>::type>::value, "");	\
	static_assert(hamon::is_unsigned<hamon::make_unsigned<T>::type>::value, "");	\
...
#endif
HAMON_MAKE_UNSIGNED_TEST_1(char16_t);
HAMON_MAKE_UNSIGNED_TEST_1(char32_t);
