...
HAMON_IS_INTEGRAL_TEST_CV(true, char8_t);
#endif
...
HAMON_IS_INTEGRAL_TEST_CV(false, f1);
HAMON_IS_INTEGRAL_TEST_CV(false, f2);
HAMON_IS_INTEGRAL_TEST_CV(false, f3);
HAMON_IS_INTEGRAL_TEST_CV(false, mf1);
HAMON_IS_INTEGRAL_TEST_CV(false, mf2);
HAMON_IS_INTEGRAL_TEST_CV(false, mf3);
HAMON_IS_INTEGRAL_TEST_CV(false, mf4);
HAMON_IS_INTEGRAL_TEST_CV(false, mp);
HAMON_IS_INTEGRAL_TEST_CV(false, cmf);
...
HAMON_IS_INTEGRAL_TEST_CV(true, __int128_t);
HAMON_IS_INTEGRAL_TEST_CV(true, __uint128_t);
#endif
