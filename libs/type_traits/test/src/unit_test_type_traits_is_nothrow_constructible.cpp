...
{
	S3();
	S3(const S3&) HAMON_NOEXCEPT_OR_NOTHROW;
	S3(S3&&) HAMON_NOEXCEPT_OR_NOTHROW;
};

HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S1[3]);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3]);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3]);

#if defined(HAMON_HAS_CXX20_AGGREGATE_PAREN_INIT)
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S1[3], S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S1[3], S1, S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S1[3], S1, S1, S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1, S1, S1, S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&, S1 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&, S1 const&, S1 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&, S1 const&, S1 const&, S1 const&);

HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2, S2);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2, S2, S2);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2, S2, S2, S2);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&, S2 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S2[3], S2 const&, S2 const&, S2 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&, S2 const&, S2 const&, S2 const&);

// 配列の要素数より引数の数が少ない場合、noexceptになるかどうかはis_nothrow_default_constructible
// が関わってくると思われるが、その挙動がコンパイラによって違う
//HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3);
//HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3, S3);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S3[3], S3, S3, S3);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3, S3, S3, S3);
//HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&);
//HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&, S3 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(true,  S3[3], S3 const&, S3 const&, S3 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&, S3 const&, S3 const&, S3 const&);
#else
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1, S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1, S1, S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1, S1, S1, S1);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&, S1 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S1[3], S1 const&, S1 const&, S1 const&);
...
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&, S2 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&, S2 const&, S2 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S2[3], S2 const&, S2 const&, S2 const&, S2 const&);

HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3, S3);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3, S3, S3);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3, S3, S3, S3);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&, S3 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&, S3 const&, S3 const&);
HAMON_IS_NOTHROW_CONSTRUCTIBLE_TEST(false, S3[3], S3 const&, S3 const&, S3 const&, S3 const&);
#endif
