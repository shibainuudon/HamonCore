/**
 *	@file	unit_test_memory_weak_ptr_assign_copy.cpp
 *
 *	@brief	コピー代入演算子のテスト
 *
...
static_assert( hamon::is_copy_assignable<hamon::weak_ptr<int>>::value, "");
static_assert( hamon::is_copy_assignable<hamon::weak_ptr<int[]>>::value, "");
static_assert( hamon::is_copy_assignable<hamon::weak_ptr<int[3]>>::value, "");

static_assert( hamon::is_nothrow_copy_assignable<hamon::weak_ptr<int>>::value, "");
static_assert( hamon::is_nothrow_copy_assignable<hamon::weak_ptr<int[]>>::value, "");
static_assert( hamon::is_nothrow_copy_assignable<hamon::weak_ptr<int[3]>>::value, "");

static_assert(!hamon::is_trivially_copy_assignable<hamon::weak_ptr<int>>::value, "");
static_assert(!hamon::is_trivially_copy_assignable<hamon::weak_ptr<int[]>>::value, "");
static_assert(!hamon::is_trivially_copy_assignable<hamon::weak_ptr<int[3]>>::value, "");
...
GTEST_TEST(WeakPtrTest, AssignCopyTest)
{
