/**
 *	@file	uninitialized_move_if_noexcept.hpp
 *
 *	@brief	uninitialized_move_if_noexcept を定義
 */

#ifndef HAMON_MEMORY_DETAIL_UNINITIALIZED_MOVE_IF_NOEXCEPT_HPP
#define HAMON_MEMORY_DETAIL_UNINITIALIZED_MOVE_IF_NOEXCEPT_HPP
...
#if defined(HAMON_HAS_CXX20_IS_CONSTANT_EVALUATED)
	return uninitialized_move_if_noexcept_impl(
	...
	hamon::detail::overload_priority<0>)
{
...
#endif
	{
		...
		{
			hamon::allocator_traits<Allocator>::construct(allocator, hamon::addressof(*current), hamon::move_if_noexcept(*ifirst));
			++current;
		}
...
uninitialized_move_if_noexcept(I ifirst, S1 ilast, O ofirst, S2 olast)
{
	...
	return hamon::detail::uninitialized_move_if_noexcept(alloc, ifirst, ilast, ofirst, olast);
}
...
#endif // HAMON_MEMORY_DETAIL_UNINITIALIZED_MOVE_IF_NOEXCEPT_HPP
