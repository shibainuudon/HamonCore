 ...
 *
 *	@brief	ranges::uninitialized_default_construct_n を定義
 */
...
// 27.11.3 uninitialized_default_construct_n[uninitialized.construct.default]
...
//	requires hamon::default_initializable<hamon::iter_value_t<I>>
	...
	{
		// [uninitialized.construct.default]/4
		return hamon::ranges::uninitialized_default_construct(
...
detail::uninitialized_default_construct_n_fn uninitialized_default_construct_n{};
