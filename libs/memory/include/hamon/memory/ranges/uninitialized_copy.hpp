 ...
 *
 *	@brief	ranges::uninitialized_copy を定義
 */
...
using uninitialized_copy_result = hamon::ranges::in_out_result<I, O>;
...
//	requires hamon::constructible_from<hamon::iter_value_t<O>, hamon::iter_reference_t<I>>
	...
	{
		return hamon::detail::uninitialized_copy_impl(ifirst, ilast, ofirst, olast);
	}
...
//	requires hamon::constructible_from<hamon::ranges::range_value_t<OR>, hamon::ranges::range_reference_t<IR>>
	uninitialized_copy_result<hamon::ranges::borrowed_iterator_t<IR>, hamon::ranges::borrowed_iterator_t<OR>>
...
detail::uninitialized_copy_fn uninitialized_copy{};
