 ...
 *
 *	@brief	ranges::uninitialized_copy_n を定義
 */

#ifndef HAMON_MEMORY_RANGES_UNINITIALIZED_COPY_N_HPP
#define HAMON_MEMORY_RANGES_UNINITIALIZED_COPY_N_HPP
...
using uninitialized_copy_n_result = hamon::ranges::in_out_result<I, O>;
...
//	requires hamon::constructible_from<hamon::iter_value_t<O>, hamon::iter_reference_t<I>>
	...
	{
		// [uninitialized.copy]/10
		auto t = hamon::ranges::uninitialized_copy(
...
detail::uninitialized_copy_n_fn uninitialized_copy_n{};
...
#endif // HAMON_MEMORY_RANGES_UNINITIALIZED_COPY_N_HPP
