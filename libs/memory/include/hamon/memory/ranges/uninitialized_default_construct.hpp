 ...
 *
 *	@brief	ranges::uninitialized_default_construct を定義
 */

#ifndef HAMON_MEMORY_RANGES_UNINITIALIZED_DEFAULT_CONSTRUCT_HPP
#define HAMON_MEMORY_RANGES_UNINITIALIZED_DEFAULT_CONSTRUCT_HPP
...
//	requires hamon::default_initializable<hamon::ranges::range_value_t<R>>
	...
	{
		return hamon::detail::uninitialized_default_construct_impl(hamon::ranges::begin(r), hamon::ranges::end(r));
	}
};
...
detail::uninitialized_default_construct_fn uninitialized_default_construct{};
...
#endif // HAMON_MEMORY_RANGES_UNINITIALIZED_DEFAULT_CONSTRUCT_HPP
